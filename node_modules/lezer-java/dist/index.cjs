...
const parser = lezer.Parser.deserialize({
  ...
  maxTerm: 271,
  nodeProps: [
    [lezer.NodeProp.group, -26,4,46,75,76,81,86,91,143,145,148,149,151,154,156,159,160,162,164,169,171,174,177,179,180,182,190,"Statement",-24,6,13,14,15,16,17,18,19,20,21,38,39,40,98,99,101,102,105,116,118,120,123,125,128,"Expression",-7,22,23,24,25,26,28,33,"Type"],
    [lezer.NodeProp.openedBy, 10,"(",43,"{"],
    [lezer.NodeProp.closedBy, 11,")",44,"}"]
  ],
  skippedNodes: [0,1,2],
  repeatNodeCount: 28,
