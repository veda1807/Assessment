(function (global, factory) {
	...
	*/
	...
	function ConditionalPortal(_a) {
	    ...
	    return (React__default['default'].createElement(Portal$1, { into: portalInto, intoId: portalIntoId }, children));
	}
	 ...
	 */
	function useDir() {
	    var _a = React.useContext(context$b); _a.root; var current = __rest$2h(_a, ["root"]);
	    return current;
	}
	/**
	 * @remarks \@since 2.3.0
	...
	options) {
	    ...
	    // @ts-expect-error
	    el[(add ? "add" : "remove") + "EventListener"]("touch" + eventType, callback, isSupported ? __assign$2I({ passive: true, capture: capture }, options) : capture);
	}
	/**
	...
	function useHoverMode(_a) {
	    ...
	    var stickyHandlers;
	    if (sticky) {
	        stickyHandlers = __assign$2H(__assign$2H({}, handlers), { onClick: onStickyClick });
	    }
	    return {
	        active: active,
	 ...
	 * @internal
	 */
	var AppSizeContext = React.createContext(__assign$2G(__assign$2G({}, DEFAULT_APP_SIZE), { __initialized: false }));
	/**
	 ...
	 */
	function useAppSize() {
	    var _a = React.useContext(AppSizeContext), __initialized = _a.__initialized, context = __rest$2g(_a, ["__initialized"]);
	    if (!__initialized) {
	...
	var GridCell = React.forwardRef(function GridCell(_a, ref) {
	    ...
	    var cellStyle = __assign$2F({ gridColumnStart: colStart, gridColumnEnd: colEnd, gridRowStart: rowStart, gridRowEnd: rowSpan ? "span " + rowSpan : rowEnd }, style);
	    var cellClassName = classnames(block$1d("cell", (_h = {},
	        _h["" + colSpan] = colSpan,
	        _h)), className);
	    if (clone && React.isValidElement(children)) {
	        var child = React.Children.only(children);
	        return React.cloneElement(child, {
	            style: __assign$2F(__assign$2F({}, child.props.style), cellStyle),
	            className: classnames(cellClassName, child.props.className),
	        });
	    }
	    return (React__default['default'].createElement("div", __assign$2F({}, props, { ref: ref, style: cellStyle, className: cellClassName }), children));
	});
	...
	var Grid = React.forwardRef(function Grid(_a, ref) {
	    ...
	    var mergedClassName = classnames(block$1c({ "no-padding": padding === 0 }), className);
	    if (cloneStyles && React.isValidElement(children)) {
	        var child = React.Children.only(children);
	        return React.cloneElement(child, {
	            style: __assign$2E(__assign$2E({}, mergedStyle), child.props.style),
	            className: classnames(mergedClassName, child.props.className),
	        });
	    }
	    ...
	    return (React__default['default'].createElement("div", __assign$2E({}, props, { ref: ref, style: mergedStyle, className: mergedClassName }), content));
	});
	...
	var GridListCell = React.forwardRef(function GridListCell(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a.square, square = _b === void 0 ? false : _b, _c = _a.clone, clone = _c === void 0 ? false : _c, props = __rest$2d(_a, ["className", "children", "square", "clone"]);
	    var cellClassName = classnames(block$1b("cell", { square: square }), className);
	    if (clone && React.isValidElement(children)) {
	        var child = React.Children.only(children);
	        return React.cloneElement(child, {
	            className: classnames(cellClassName, child.props.className),
	    ...
	    return (React__default['default'].createElement("div", __assign$2D({}, props, { ref: ref, className: cellClassName }), children));
	});
	        ...
	        var observer = new ResizeObserver$1(function (entries) {
	            for (var i = 0; i < entries.length; i += 1) {
	                ...
	                if ((isNewHeight && !disableHeight) || (isNewWidth && !disableWidth)) {
	                    onResize(__assign$2C(__assign$2C({}, nextSize), { element: target_1 }));
	                }
	            }
	        });
	        ...
	        var _loop_1 = function (i) {
	            ...
	            for (var j = 0; j < currentSubscriptions.length; j += 1) {
	                ...
	                if ((isNewHeight && !disableHeight) || (isNewWidth && !disableWidth)) {
	                    ...
	                    handler(__assign$2B(__assign$2B({}, nextSize), { element: entry.target }));
	                }
	            }
	        };
	...
	function useGridList(_a) {
	    ...
	    var mergedStyle = __assign$2A(__assign$2A({}, style), (_b = {}, _b[CELL_SIZE_VAR] = gridSize.cellWidth + "px", _b));
	    if (cellMargin) {
	    ...
	    return [
	        {
	            ref: refHandler,
	            style: mergedStyle,
	            className: classnames("rmd-grid-list", className),
	        },
	        gridSize,
	    ];
	}
	...
	var GridList = React.forwardRef(function GridList(_a, forwardedRef) {
	    var style = _a.style, className = _a.className, children = _a.children, _b = _a.clone, clone = _b === void 0 ? false : _b, _c = _a.wrapOnly, wrapOnly = _c === void 0 ? false : _c, cellMargin = _a.cellMargin, defaultSize = _a.defaultSize, _d = _a.maxCellSize, maxCellSize = _d === void 0 ? DEFAULT_GRID_LIST_MAX_CELL_SIZE : _d, _e = _a.containerPadding, containerPadding = _e === void 0 ? DEFAULT_GRID_LIST_PADDING : _e, _f = _a.disableHeightObserver, disableHeightObserver = _f === void 0 ? false : _f, _g = _a.disableWidthObserver, disableWidthObserver = _g === void 0 ? false : _g, props = __rest$2c(_a, ["style", "className", "children", "clone", "wrapOnly", "cellMargin", "defaultSize", "maxCellSize", "containerPadding", "disableHeightObserver", "disableWidthObserver"]);
	    var _h = useGridList({
	        ref: forwardedRef,
	        style: style,
	        className: className,
	    ...
	    return (React__default['default'].createElement(GridListSizeProvider, { value: gridSize },
	        React__default['default'].createElement("div", __assign$2z({}, props, gridListProps), content)));
	});
	...
	function AppSizeListener(_a) {
	    ...
	    var value = React.useMemo(function () { return (__assign$2y(__assign$2y({}, appSize), { __initialized: true })); }, [appSize]);
	...
	var FocusContainer = React.forwardRef(function FocusContainer(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(Component, __assign$2x({}, props, { onKeyDown: handleKeyDown, ref: refHandler }), children));
	});
	 ...
	 * movements.
	 */
	var HORIZONTAL_MENU = __assign$2w(__assign$2w({}, VERTICAL_MENU), { incrementKeys: [exports.IncrementMovementKey.ArrowRight], decrementKeys: [exports.IncrementMovementKey.ArrowLeft] });
	/**
	 * A keyboard movement configuration preset for handling vertical listbox
	 * movements.
	 */
	var VERTICAL_LISTBOX = __assign$2w(__assign$2w({}, VERTICAL_MENU), { loopable: false });
	/**
	 * A keyboard movement configuration preset for handling horizontal listbox
	 * movements.
	 */
	var HORIZONTAL_LISTBOX = __assign$2w(__assign$2w({}, HORIZONTAL_MENU), { loopable: false });
	/**
	...
	function useActiveDescendantMovement(_a) {
	    ...
	    var _g = useKeyboardMovement(__assign$2v(__assign$2v({}, options), { valueKey: valueKey,
	        getItemValue: getItemValue,
	...
	function useFocusMovement(_a) {
	    var _b = _a.defaultFocusedIndex, defaultFocusedIndex = _b === void 0 ? -1 : _b, onChange = _a.onChange, options = __rest$29(_a, ["defaultFocusedIndex", "onChange"]);
	    var _c = React.useState(defaultFocusedIndex), focusedIndex = _c[0], setFocusedIndex = _c[1];
	    var _d = useKeyboardMovement(__assign$2u(__assign$2u({}, options), { focusedIndex: focusedIndex,
	        onChange: function (data, itemRefs) {
	            if (onChange) {
	                onChange(data, itemRefs);
	            }
	...
	var RadioWidget = React.forwardRef(function RadioGroupRadio(_a, ref) {
	    var checked = _a.checked, children = _a.children, props = __rest$28(_a, ["checked", "children"]);
	    return (React__default['default'].createElement("span", __assign$2t({}, props, { "aria-checked": checked, ref: ref, role: "radio" }), children));
	});
	...
	var RadioGroup = React.forwardRef(function RadioGroup(_a, ref) {
	    ...
	    return (React__default['default'].createElement("span", __assign$2s({}, props, { id: id, ref: ref, role: "radiogroup", onBlur: handleBlur, onFocus: handleFocus, onClick: handleClick, onKeyDown: handleKeyDown, tabIndex: -1 }), items.map(function (item, i) {
	        var props;
	        var value;
	        var checked = false;
	        var children;
	        ...
	        if (typeof item === "string") {
	            ...
	            (value = item.value, children = item.children, props = __rest$27(item, ["value", "children"]));
	            checked = currentValue === value;
	            itemStyle = getRadioStyle(__assign$2s({ index: i, checked: checked }, item));
	            itemClassName =
	                getRadioClassName(__assign$2s({ index: i, checked: checked }, item)) || undefined;
	            if (typeof children === "undefined") {
	                children = value;
	            }
	        }
	        return (React__default['default'].createElement(RadioWidget, __assign$2s({}, props, { key: value, id: id + "-" + (i + 1), ref: refs[i], style: itemStyle, className: itemClassName, checked: checked, tabIndex: checked || (!focused && !focusable) ? 0 : -1 }), children));
	    })));
	});
	...
	var Snackbar = React.forwardRef(function Snackbar(_a, ref) {
	    var _b;
	    var className = _a.className, children = _a.children, _c = _a.portal, portal = _c === void 0 ? false : _c, portalInto = _a.portalInto, portalIntoId = _a.portalIntoId, _d = _a.position, position = _d === void 0 ? "bottom" : _d, props = __rest$26(_a, ["className", "children", "portal", "portalInto", "portalIntoId", "position"]);
	    return (React__default['default'].createElement(ConditionalPortal, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId },
	        React__default['default'].createElement("div", __assign$2r({}, props, { role: "status", ref: ref, className: classnames(block$1a((_b = {}, _b[position] = true, _b)), className) }), children)));
	});
	...
	*/
	...
	var Toast = React.forwardRef(function Toast(_a, ref) {
	    var className = _a.className, children = _a.children, onEnter = _a.onEnter, onEntering = _a.onEntering, onEntered = _a.onEntered, onExit = _a.onExit, onExiting = _a.onExiting, onExited = _a.onExited, _b = _a.timeout, timeout = _b === void 0 ? DEFAULT_TOAST_TIMEOUT : _b, _c = _a.classNames, classNames = _c === void 0 ? DEFAULT_TOAST_CLASSNAMES : _c, _d = _a.action, action = _d === void 0 ? null : _d, _e = _a.stacked, stacked = _e === void 0 ? false : _e, _f = _a.twoLines, twoLines = _f === void 0 ? false : _f, visible = _a.visible, props = __rest$25(_a, ["className", "children", "onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "timeout", "classNames", "action", "stacked", "twoLines", "visible"]);
	    return (React__default['default'].createElement(CSSTransition, { in: visible, appear: true, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: timeout, classNames: classNames, mountOnEnter: true, unmountOnExit: true },
	        React__default['default'].createElement("div", __assign$2q({}, props, { ref: ref, className: classnames(block$19({
	                stacked: stacked,
	...
	function enteredRipple(state, ripple) {
	    ...
	    nextState[i] = __assign$2p(__assign$2p({}, ripple), { exiting: exiting, entered: true });
	    return nextState;
	}
	function releaseRipple(state) {
	    ...
	    var nextState = state.slice();
	    nextState[i] = __assign$2p(__assign$2p({}, ripple), { exiting: exiting, holding: false });
	    return nextState;
	}
	...
	function cancelRipples(state, ease) {
	    if (ease) {
	        return state.map(function (r) { return (__assign$2p(__assign$2p({}, r), { exiting: true, mounted: true, holding: false })); });
	    }
	    return [];
	}
	...
	function Ripple(_a) {
	    ...
	    return (React__default['default'].createElement(CSSTransition, { in: !exiting, appear: true, classNames: classNames, timeout: timeout, onEntered: onEntered, onExited: onExited },
	        React__default['default'].createElement("span", { style: style, className: classnames("rmd-ripple", className) })));
	}
	...
	function RippleContainer(_a) {
	    ...
	    return (React__default['default'].createElement("span", { className: classnames("rmd-ripple-container", className) }, ripples.map(function (ripple) { return (React__default['default'].createElement(Ripple, { key: ripple.startTime, ripple: ripple, className: rippleClassName, entered: entered, exited: exited, timeout: timeout, classNames: classNames })); })));
	}
	...
	function useRippleHandlers(_a) {
	    ...
	    var ref = useRefCache(__assign$2o(__assign$2o({}, handlers), { disableProgrammaticRipple: disableProgrammaticRipple }));
	...
	function useRipples(_a) {
	    ...
	    var handlers = useRippleHandlers(__assign$2n({ create: create,
	        release: release,
	        cancel: cancel,
	...
	function usePressedStates(_a) {
	    ...
	    var ref = useRefCache(__assign$2m(__assign$2m({}, handlers), { pressed: pressed }));
	    var handleKeyDown = React.useCallback(function (event) {
	...
	function useInteractionStates(options) {
	    ...
	    var handlers = null;
	    var ripples = null;
	    var ripplesResult = useRipples(__assign$2l(__assign$2l({}, options), { disableSpacebarClick: disableSpacebarClick,
	        disableRipple: disableRipple,
	        disableProgrammaticRipple: disableProgrammaticRipple,
	        rippleTimeout: rippleTimeout,
	    ...
	    var pressedResult = usePressedStates(__assign$2l(__assign$2l({}, options), { handlers: handlers || options.handlers, disableSpacebarClick: disableSpacebarClick }));
	    if (enablePressedAndRipple || (disableRipple && !disablePressedFallback)) {
	        (handlers = pressedResult.handlers);
	        className = classnames(className, { "rmd-states--pressed": pressedResult.pressed });
	    }
	...
	var FAB = React.forwardRef(function FAB(_a, ref) {
	    var _b = _a.position, position = _b === void 0 ? null : _b, children = _a.children, className = _a.className, props = __rest$23(_a, ["position", "children", "className"]);
	    if (!position) {
	        return React__default['default'].createElement(React__default['default'].Fragment, null, children);
	    }
	    return (React__default['default'].createElement("span", __assign$2k({}, props, { ref: ref, className: classnames(styles$d({
	...
	var Button = React.forwardRef(function Button(_a, ref) {
	    ...
	    return (React__default['default'].createElement(FAB, __assign$2j({ position: floating }, floatingProps),
	        React__default['default'].createElement("button", __assign$2j({ "aria-disabled": isDisabledTheme || undefined }, props, (isDisabledTheme ? undefined : handlers), { ref: ref, type: type, className: className, disabled: disabled }),
	            children,
	            ripples)));
	});
	...
	var UnstyledButton = React.forwardRef(function UnstyledButton(_a, ref) {
	    var className = _a.className, children = _a.children, props = __rest$21(_a, ["className", "children"]);
	    return (React__default['default'].createElement("button", __assign$2i({}, props, { type: "button", ref: ref, className: classnames("rmd-button-unstyled", className) }), children));
	});
	...
	function SnackbarQueueT(_a, ref) {
	    var queue = _a.queue, onActionClick = _a.onActionClick, props = __rest$20(_a, ["queue", "onActionClick"]);
	    var toast = queue[0];
	    ...
	    if (toast) {
	        ...
	        toast.messageId; toast.messagePriority; var _c = toast.disableAutohide, disableAutohide = _c === void 0 ? false : _c, _d = toast.disableActionHide, disableActionHide_1 = _d === void 0 ? false : _d, providedAction = toast.action, toastProps = __rest$20(toast, ["messageId", "messagePriority", "disableAutohide", "disableActionHide", "action"]);
	        var action = null;
	        if (providedAction) {
	            ...
	            if (React.isValidElement(providedAction) || t !== "object") {
	                ...
	                action = (React__default['default'].createElement(Button, __assign$2h({ id: getId(snackbarId, toastId, actionProps_1.id), theme: "secondary" }, actionProps_1, { onClick: onClick })));
	            }
	        }
	        content = (React__default['default'].createElement(Toast, __assign$2h({}, toastProps, { action: action, visible: visible, onEntered: disableAutohide ? undefined : startTimer, onExited: popMessage })));
	    }
	    return (React__default['default'].createElement(Snackbar, __assign$2h({}, props, { ref: ref }), content));
	}
	...
	function MessageQueue(_a) {
	    var _b = _a.timeout, timeout = _b === void 0 ? 5000 : _b, _c = _a.duplicates, duplicates = _c === void 0 ? "allow" : _c, _d = _a.defaultQueue, defaultQueue = _d === void 0 ? [] : _d, children = _a.children, props = __rest$1$(_a, ["timeout", "duplicates", "defaultQueue", "children"]);
	    ...
	    return (React__default['default'].createElement(AddMessageContext.Provider, { value: addMessage },
	        React__default['default'].createElement(MessageQueueActionsContext.Provider, { value: actions },
	            React__default['default'].createElement(MessageVisibilityContext.Provider, { value: visible },
	                ...
	                React__default['default'].createElement(SnackbarQueue, __assign$2g({}, props, { queue: queue }))))));
	}
	...
	var AppBar = React.forwardRef(function AppBar(_a, ref) {
	    ...
	    var className = _a.className, children = _a.children, _c = _a.theme, propTheme = _c === void 0 ? "primary" : _c, _d = _a.component, propComponent = _d === void 0 ? "header" : _d, _e = _a.height, height = _e === void 0 ? "normal" : _e, _f = _a.fixed, fixed = _f === void 0 ? false : _f, _g = _a.fixedPosition, fixedPosition = _g === void 0 ? "top" : _g, _h = _a.fixedElevation, fixedElevation = _h === void 0 ? true : _h, inheritColor = _a.inheritColor, _j = _a.flexWrap, flexWrap = _j === void 0 ? height === "none" ||
	        height === "prominent" ||
	        height === "prominent-dense" : _j, remaining = __rest$1_(_a, ["className", "children", "theme", "component", "height", "fixed", "fixedPosition", "fixedElevation", "inheritColor", "flexWrap"]);
	    ...
	    return (React__default['default'].createElement(ParentContext.Provider, { value: true },
	        React__default['default'].createElement(InheritContext.Provider, { value: inherit },
	            React__default['default'].createElement(Component, __assign$2f({}, remaining, { className: classnames(block$17((_b = {},
	...
	var AppBarTitle = React.forwardRef(function AppBarTitle(_a, ref) {
	    var _b = _a.noWrap, noWrap = _b === void 0 ? true : _b, _c = _a.keyline, keyline = _c === void 0 ? false : _c, className = _a.className, children = _a.children, inheritColor = _a.inheritColor, props = __rest$1Z(_a, ["noWrap", "keyline", "className", "children", "inheritColor"]);
	    return (React__default['default'].createElement("h6", __assign$2e({}, props, { ref: ref, className: classnames(block$16("title", {
	            "no-wrap": noWrap,
	            keyline: keyline,
	...
	var AppBarNav = React.forwardRef(function AppBarNav(_a, ref) {
	    var className = _a.className, children = _a.children, inheritColor = _a.inheritColor, floating = _a.floating, _b = _a.theme, theme = _b === void 0 ? floating ? "secondary" : "clear" : _b, _c = _a.buttonType, buttonType = _c === void 0 ? "icon" : _c, props = __rest$1Y(_a, ["className", "children", "inheritColor", "floating", "theme", "buttonType"]);
	    return (React__default['default'].createElement(Button, __assign$2d({}, props, { theme: theme, floating: floating, buttonType: buttonType, ref: ref, className: classnames(block$15("nav", {
	            inherit: useInheritContext(inheritColor),
	        }), className) }), children));
	});
	...
	function useActionClassName(_a) {
	    ...
	    return classnames(block$14("action", {
	        first: first,
	        last: last,
	        inherit: useInheritContext(inheritColor),
	    }), className);
	...
	var AppBarAction = React.forwardRef(function AppBarAction(_a, ref) {
	    var className = _a.className, _b = _a.first, first = _b === void 0 ? false : _b, _c = _a.last, last = _c === void 0 ? false : _c, children = _a.children, inheritColor = _a.inheritColor, floating = _a.floating, _d = _a.theme, theme = _d === void 0 ? floating ? "secondary" : "clear" : _d, _e = _a.buttonType, buttonType = _e === void 0 ? "icon" : _e, props = __rest$1X(_a, ["className", "first", "last", "children", "inheritColor", "floating", "theme", "buttonType"]);
	    return (React__default['default'].createElement(Button, __assign$2c({}, props, { theme: theme, buttonType: buttonType, floating: floating, ref: ref, className: useActionClassName({ first: first, last: last, inheritColor: inheritColor, className: className }) }), children));
	});
	...
	var Form = React.forwardRef(function Form(_a, ref) {
	    var children = _a.children, _b = _a.disablePreventDefault, disablePreventDefault = _b === void 0 ? false : _b, onSubmit = _a.onSubmit, props = __rest$1W(_a, ["children", "disablePreventDefault", "onSubmit"]);
	    ...
	    return (React__default['default'].createElement("form", __assign$2b({}, props, { onSubmit: handleOnSubmit, ref: ref }), children));
	});
	...
	var Fieldset = React.forwardRef(function Fieldset(_a, ref) {
	    var className = _a.className, legend = _a.legend, legendStyle = _a.legendStyle, legendClassName = _a.legendClassName, _b = _a.legendSROnly, legendSROnly = _b === void 0 ? false : _b, _c = _a.unstyled, unstyled = _c === void 0 ? true : _c, children = _a.children, props = __rest$1V(_a, ["className", "legend", "legendStyle", "legendClassName", "legendSROnly", "unstyled", "children"]);
	    return (React__default['default'].createElement("fieldset", __assign$2a({}, props, { ref: ref, className: classnames(block$13({ unstyled: unstyled }), className) }),
	        React__default['default'].createElement("legend", { style: legendStyle, className: classnames(block$13("legend", { "sr-only": legendSROnly }), legendClassName) }, legend),
	        children));
	});
	...
	var FormMessage = React.forwardRef(function FormMessage(_a, ref) {
	    var _b;
	    var id = _a.id, role = _a.role, className = _a.className, counterStyle = _a.counterStyle, counterClassName = _a.counterClassName, messageStyle = _a.messageStyle, messageClassName = _a.messageClassName, _c = _a.error, error = _c === void 0 ? false : _c, _d = _a.disableWrap, disableWrap = _d === void 0 ? false : _d, propTheme = _a.theme, children = _a.children, length = _a.length, maxLength = _a.maxLength, props = __rest$1U(_a, ["id", "role", "className", "counterStyle", "counterClassName", "messageStyle", "messageClassName", "error", "disableWrap", "theme", "children", "length", "maxLength"]);
	    var theme = useFormTheme({ theme: propTheme }).theme;
	    var message = children;
	    if (!disableWrap && children) {
	        message = (React__default['default'].createElement("p", { id: id + "-message", style: messageStyle, className: classnames(block$12("message"), messageClassName) }, children));
	    }
	    return (React__default['default'].createElement("div", __assign$29({}, props, { id: id, ref: ref, "aria-live": role !== "alert" ? "polite" : undefined, role: role, className: classnames(block$12((_b = {
	                error: error
	            },
	            _b[theme] = theme !== "none",
	            _b)), className) }),
	        message,
	        typeof length === "number" && typeof maxLength === "number" && (React__default['default'].createElement("span", { id: id + "-counter", style: counterStyle, className: classnames(block$12("counter"), counterClassName) }, length + " / " + maxLength))));
	});
	...
	var FormMessageContainer = React.forwardRef(function FormMessageContainer(_a, ref) {
	    var className = _a.className, children = _a.children, messageProps = _a.messageProps, props = __rest$1T(_a, ["className", "children", "messageProps"]);
	    if (!messageProps) {
	        return React__default['default'].createElement(React__default['default'].Fragment, null, children);
	    }
	    return (React__default['default'].createElement("div", __assign$28({}, props, { ref: ref, className: classnames("rmd-field-message-container", className) }),
	        children,
	        React__default['default'].createElement(FormMessage, __assign$28({}, messageProps))));
	});
	...
	var FontIcon = React.forwardRef(function FontIcon(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a["aria-hidden"], ariaHidden = _b === void 0 ? true : _b, _c = _a.dense, dense = _c === void 0 ? false : _c, _d = _a.iconClassName, iconClassName = _d === void 0 ? "material-icons" : _d, _e = _a.forceSize, forceSize = _e === void 0 ? false : _e, _f = _a.forceFontSize, forceFontSize = _f === void 0 ? false : _f, props = __rest$1S(_a, ["className", "children", "aria-hidden", "dense", "iconClassName", "forceSize", "forceFontSize"]);
	    return (React__default['default'].createElement("i", __assign$27({}, props, { "aria-hidden": ariaHidden, ref: ref, className: classnames(block$11({
	            font: true,
	            dense: dense,
	...
	var SVGIcon = React.forwardRef(function SVGIcon(_a, ref) {
	    var _b = _a["aria-hidden"], ariaHidden = _b === void 0 ? true : _b, _c = _a.focusable, focusable = _c === void 0 ? "false" : _c, _d = _a.xmlns, xmlns = _d === void 0 ? "http://www.w3.org/2000/svg" : _d, _e = _a.viewBox, viewBox = _e === void 0 ? "0 0 24 24" : _e, _f = _a.dense, dense = _f === void 0 ? false : _f, className = _a.className, use = _a.use, propChildren = _a.children, props = __rest$1R(_a, ["aria-hidden", "focusable", "xmlns", "viewBox", "dense", "className", "use", "children"]);
	    var children = propChildren;
	    if (!children && use) {
	        children = React__default['default'].createElement("use", { xlinkHref: use });
	    }
	    return (React__default['default'].createElement("svg", __assign$26({}, props, { "aria-hidden": ariaHidden, ref: ref, className: classnames(block$10({ svg: true, dense: dense }), className), focusable: focusable, xmlns: xmlns, viewBox: viewBox }), children));
	});
	...
	function TextIconSpacing(_a) {
	    ...
	    var baseClassName = classnames((_b = {},
	    ...
	    if (!forceIconWrap && React.isValidElement(propIcon)) {
	        ...
	        iconEl = React.cloneElement(icon, {
	            className: classnames(baseClassName, icon.props.className),
	        });
	    }
	    else if (propIcon) {
	        iconEl = (React__default['default'].createElement("span", { className: classnames("rmd-text-icon-spacing", baseClassName) }, propIcon));
	    }
	    if (iconEl) {
	...
	var IconRotator = React.forwardRef(function IconRotator(_a, ref) {
	    var style = _a.style, propClassName = _a.className, _b = _a.animate, animate = _b === void 0 ? true : _b, rotated = _a.rotated, children = _a.children, _c = _a.forceIconWrap, forceIconWrap = _c === void 0 ? false : _c, props = __rest$1Q(_a, ["style", "className", "animate", "rotated", "children", "forceIconWrap"]);
	    var className = classnames(block$$({ animate: animate, rotated: rotated }), propClassName);
	    ...
	    return (React__default['default'].createElement("span", __assign$25({}, props, { style: style, className: className, ref: ref }), children));
	});
	...
	var Text = React.forwardRef(function Text(_a, ref) {
	    var _b;
	    var propClassName = _a.className, children = _a.children, _c = _a.type, type = _c === void 0 ? "body-1" : _c, _d = _a.component, component = _d === void 0 ? null : _d, align = _a.align, color = _a.color, decoration = _a.decoration, transform = _a.transform, weight = _a.weight, fontStyle = _a.fontStyle, _e = _a.margin, margin = _e === void 0 ? "initial" : _e, props = __rest$1P(_a, ["className", "children", "type", "component", "align", "color", "decoration", "transform", "weight", "fontStyle", "margin"]);
	    var className = classnames(block$_((_b = {},
	        _b[type] = true,
	    ...
	    return React.createElement(getComponent(component, type), __assign$24(__assign$24({}, props), { className: className, ref: ref }), children);
	});
	...
	var TextContainer = React.forwardRef(function TextContainer(_a, ref) {
	    var propClassName = _a.className, _b = _a.component, Component = _b === void 0 ? "div" : _b, _c = _a.size, size = _c === void 0 ? "auto" : _c, children = _a.children, clone = _a.clone, props = __rest$1O(_a, ["className", "component", "size", "children", "clone"]);
	    var className = classnames("rmd-text-container rmd-text-container--" + size, propClassName);
	    if (clone && React.isValidElement(children)) {
	        var child = React.Children.only(children);
	        return React.cloneElement(child, {
	    ...
	    return (React__default['default'].createElement(Component, __assign$23({}, props, { className: className, ref: ref }), children));
	});
	...
	var SrOnly = React.forwardRef(function SrOnly(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a.focusable, focusable = _b === void 0 ? false : _b, propTabIndex = _a.tabIndex, _c = _a.component, component = _c === void 0 ? "span" : _c, props = __rest$1N(_a, ["className", "children", "focusable", "tabIndex", "component"]);
	    var tabIndex = propTabIndex;
	    if (focusable && typeof tabIndex === "undefined") {
	        tabIndex = 0;
	    }
	    return (React__default['default'].createElement(Text, __assign$22({}, props, { ref: ref, tabIndex: tabIndex, component: component, className: classnames(block$Z({ focusable: focusable }), className) }), children));
	});
	...
	var FileInput = React.forwardRef(function FileInput(_a, ref) {
	    ...
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        React__default['default'].createElement("input", __assign$21({}, props, handlers, { ref: ref, onChange: onChange, value: disableRepeatableFiles ? undefined : "", type: "file", className: block$Y(), multiple: multiple })),
	        React__default['default'].createElement("label", { htmlFor: id, style: style, className: classnames("rmd-file-input-label", className) },
	            content,
	            ripples)));
	});
	...
	var labelStyles = function (_a) {
	    ...
	    return styles$c({ error: error, active: active, disabled: disabled });
	};
	/**
	...
	var Label = React.forwardRef(function Label(_a, ref) {
	    var htmlFor = _a.htmlFor, className = _a.className, _b = _a.error, error = _b === void 0 ? false : _b, _c = _a.active, active = _c === void 0 ? false : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.component, Component = _e === void 0 ? "label" : _e, children = _a.children, props = __rest$1L(_a, ["htmlFor", "className", "error", "active", "disabled", "component", "children"]);
	    if (!children) {
	        return null;
	    }
	    return (React__default['default'].createElement(Component, __assign$20({}, props, { ref: ref, className: classnames(labelStyles({ error: error, active: active, disabled: disabled }), className), htmlFor: Component === "label" ? htmlFor : undefined }), children));
	});
	...
	var List = React.forwardRef(function List(_a, ref) {
	    var _b = _a.role, role = _b === void 0 ? "none" : _b, _c = _a.dense, dense = _c === void 0 ? false : _c, _d = _a.ordered, ordered = _d === void 0 ? false : _d, _e = _a.horizontal, horizontal = _e === void 0 ? false : _e, className = _a.className, children = _a.children, props = __rest$1K(_a, ["role", "dense", "ordered", "horizontal", "className", "children"]);
	    var Component = (ordered ? "ol" : "ul");
	    return (React__default['default'].createElement(Component, __assign$1$({}, props, { ref: ref, role: role, className: classnames(block$X({ dense: dense, horizontal: horizontal }), className) }), children));
	});
	...
	function ListItemAddon(_a) {
	    var _b;
	    var className = _a.className, children = _a.children, addon = _a.addon, _c = _a.addonAfter, addonAfter = _c === void 0 ? false : _c, _d = _a.type, type = _d === void 0 ? "icon" : _d, _e = _a.position, position = _e === void 0 ? "middle" : _e, forceAddonWrap = _a.forceAddonWrap, props = __rest$1J(_a, ["className", "children", "addon", "addonAfter", "type", "position", "forceAddonWrap"]);
	    var isMedia = type === "media" || type === "large-media";
	    var isAvatar = type === "avatar";
	    return (React__default['default'].createElement(TextIconSpacing, __assign$1_({}, props, { icon: addon, forceIconWrap: forceAddonWrap !== null && forceAddonWrap !== void 0 ? forceAddonWrap : isMedia, className: classnames(base("addon", (_b = {},
	...
	function ListItemText(_a) {
	    ...
	    if (secondaryText) {
	        secondaryContent = (React__default['default'].createElement("span", { className: classnames(block$W("text", { secondary: true }), secondaryTextClassName) }, secondaryText));
	    }
	    return (React__default['default'].createElement("span", { className: classnames(block$W("text"), className) },
	        children,
	        secondaryContent));
	}
	...
	var SimpleListItem = React.forwardRef(function SimpleListItem(_a, ref) {
	    var _b;
	    var className = _a.className, textClassName = _a.textClassName, secondaryTextClassName = _a.secondaryTextClassName, textChildren = _a.textChildren, primaryText = _a.primaryText, secondaryText = _a.secondaryText, leftAddon = _a.leftAddon, _c = _a.leftAddonType, leftAddonType = _c === void 0 ? "icon" : _c, _d = _a.leftAddonPosition, leftAddonPosition = _d === void 0 ? "middle" : _d, rightAddon = _a.rightAddon, _e = _a.rightAddonType, rightAddonType = _e === void 0 ? "icon" : _e, _f = _a.rightAddonPosition, rightAddonPosition = _f === void 0 ? "middle" : _f, forceAddonWrap = _a.forceAddonWrap, children = _a.children, _g = _a.height, propHeight = _g === void 0 ? "auto" : _g, _h = _a.threeLines, threeLines = _h === void 0 ? false : _h, _j = _a.clickable, clickable = _j === void 0 ? false : _j, onClick = _a.onClick, _k = _a.disabled, disabled = _k === void 0 ? false : _k, _l = _a.disabledOpacity, disabledOpacity = _l === void 0 ? false : _l, props = __rest$1I(_a, ["className", "textClassName", "secondaryTextClassName", "textChildren", "primaryText", "secondaryText", "leftAddon", "leftAddonType", "leftAddonPosition", "rightAddon", "rightAddonType", "rightAddonPosition", "forceAddonWrap", "children", "height", "threeLines", "clickable", "onClick", "disabled", "disabledOpacity"]);
	    ...
	    return (React__default['default'].createElement("li", __assign$1Z({}, props, { "aria-disabled": isDisabled || undefined, ref: ref, className: classnames(block$V((_b = {},
	...
	var ListItem = React.forwardRef(function ListItem(_a, ref) {
	    ...
	    return (React__default['default'].createElement(SimpleListItem, __assign$1Y({}, props, handlers, { ref: ref, tabIndex: tabIndex, disabled: disabled, role: role, className: className, clickable: true, height: height }),
	        React__default['default'].createElement(ListItemChildren, { textClassName: textClassName, secondaryTextClassName: secondaryTextClassName, textChildren: textChildren, primaryText: primaryText, secondaryText: secondaryText, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition, forceAddonWrap: forceAddonWrap }, children),
	        ripples));
	});
	...
	var ListItemLink = React.forwardRef(function ListItemLink(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Component, __assign$1X({}, props, handlers, { ref: ref, className: classnames("rmd-list-item rmd-list-item--clickable rmd-list-item--link", (_b = {},
	...
	var ListSubheader = React.forwardRef(function ListSubheader(_a, ref) {
	    var className = _a.className, _b = _a.inset, inset = _b === void 0 ? false : _b, props = __rest$1F(_a, ["className", "inset"]);
	    return (React__default['default'].createElement("li", __assign$1W({}, props, { ref: ref, className: classnames(block$U({ inset: inset }), className) })));
	});
	...
	var styles$b = bem("rmd-toggle");
	/**
	 * @remarks \@since 2.8.0
	 */
	var InputToggleIcon = React.forwardRef(function InputToggleIcon(_a, ref) {
	    var _b = _a.circle, circle = _b === void 0 ? false : _b, _c = _a.disabled, disabled = _c === void 0 ? false : _c, _d = _a.overlay, overlay = _d === void 0 ? false : _d, _e = _a.checked, checked = _e === void 0 ? false : _e, _f = _a.indeterminate, indeterminate = _f === void 0 ? false : _f, className = _a.className, children = _a.children, props = __rest$1E(_a, ["circle", "disabled", "overlay", "checked", "indeterminate", "className", "children"]);
	    return (React__default['default'].createElement("span", __assign$1V({}, props, { ref: ref, className: classnames(styles$b("icon", {
	            circle: circle,
	            disabled: disabled,
	            overlay: overlay,
	            checked: checked,
	...
	var SwitchTrack = React.forwardRef(function SwitchTrack(_a, ref) {
	    var id = _a.id, _b = _a.disabled, disabled = _b === void 0 ? false : _b, _c = _a.checked, checked = _c === void 0 ? false : _c, className = _a.className, ballStyle = _a.ballStyle, ballClassName = _a.ballClassName, containerProps = _a.containerProps, children = _a.children, props = __rest$1D(_a, ["id", "disabled", "checked", "className", "ballStyle", "ballClassName", "containerProps", "children"]);
	    return (React__default['default'].createElement("span", __assign$1U({}, containerProps, { className: classnames(styles$a(), containerProps === null || containerProps === void 0 ? void 0 : containerProps.className) }),
	        id && (React__default['default'].createElement(React__default['default'].Fragment, null,
	            React__default['default'].createElement("input", __assign$1U({}, props, { id: id, ref: ref, type: "checkbox", className: classnames(styles$a("input"), className), disabled: disabled })),
	            React__default['default'].createElement("label", { htmlFor: id, "aria-hidden": true, style: ballStyle, className: classnames(styles$a("ball"), ballClassName) }, children))),
	        !id && (React__default['default'].createElement("span", { style: ballStyle, className: classnames(styles$a("ball", { checked: checked }), ballClassName) }))));
	});
	...
	var styles$9 = bem("rmd-input-toggle-menu-item");
	/**
	...
	var MenuItemInputToggle = React.forwardRef(function MenuItemInputToggle(_a, ref) {
	    var children = _a.children, _b = _a.tabIndex, tabIndex = _b === void 0 ? -1 : _b, checked = _a.checked, type = _a.type, propIcon = _a.icon, _c = _a.iconAfter, iconAfter = _c === void 0 ? false : _c, addon = _a.addon, addonType = _a.addonType, addonPosition = _a.addonPosition, onClick = _a.onClick, onCheckedChange = _a.onCheckedChange, _d = _a.disabled, disabled = _d === void 0 ? false : _d, className = _a.className, props = __rest$1C(_a, ["children", "tabIndex", "checked", "type", "icon", "iconAfter", "addon", "addonType", "addonPosition", "onClick", "onCheckedChange", "disabled", "className"]);
	    ...
	    return (React__default['default'].createElement(ListItem, __assign$1T({}, props, { disableRipple: true, "aria-disabled": disabled || undefined, "aria-checked": checked, role: type === "radio" ? "menuitemradio" : "menuitemcheckbox", onClick: function (event) {
	            onClick === null || onClick === void 0 ? void 0 : onClick(event);
	            onCheckedChange(!checked, event);
	        }, ref: ref, className: classnames(styles$9(), className), tabIndex: tabIndex, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition }), children));
	});
	...
	var MenuItemCheckbox = React.forwardRef(function MenuItemCheckbox(_a, ref) {
	    ...
	    return (React__default['default'].createElement(MenuItemInputToggle, __assign$1S({}, props, { ref: ref, icon: icon, type: "checkbox" })));
	});
	...
	var MenuItemRadio = React.forwardRef(function MenuItemRadio(_a, ref) {
	    var propIcon = _a.icon, props = __rest$1A(_a, ["icon"]);
	    var icon = useIcon("radio", propIcon);
	    return (React__default['default'].createElement(MenuItemInputToggle, __assign$1R({}, props, { ref: ref, icon: icon, type: "radio" })));
	});
	...
	var MenuItemSwitch = React.forwardRef(function MenuItemSwitch(props, ref) {
	    return React__default['default'].createElement(MenuItemInputToggle, __assign$1Q({}, props, { ref: ref, type: "switch" }));
	});
	...
	var FloatingLabel = React.forwardRef(function FloatingLabel(_a, ref) {
	    var className = _a.className, dense = _a.dense, valued = _a.valued, floating = _a.floating, _b = _a.error, error = _b === void 0 ? false : _b, _c = _a.active, active = _c === void 0 ? false : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, props = __rest$1z(_a, ["className", "dense", "valued", "floating", "error", "active", "disabled"]);
	    return (React__default['default'].createElement(Label, __assign$1P({}, props, { ref: ref, className: classnames(block$T({
	            dense: dense,
	            active: floating,
	...
	var TextFieldAddon = React.forwardRef(function TextFieldAddon(_a, ref) {
	    var children = _a.children, className = _a.className, _b = _a.presentational, presentational = _b === void 0 ? true : _b, props = __rest$1y(_a, ["children", "className", "presentational"]);
	    if (!children) {
	        return null;
	    }
	    return (React__default['default'].createElement("span", __assign$1O({}, props, { ref: ref, className: classnames(block$S({ presentational: presentational }), className) }), children));
	});
	...
	var TextFieldContainer = React.forwardRef(function TextFieldContainer(_a, ref) {
	    ...
	    return (React__default['default'].createElement("div", __assign$1N({}, props, { ref: ref, className: classnames(block$R((_b = {
	                error: error,
	                inline: inline,
	                filled: filled,
	                outline: outline,
	...
	var NativeSelect = React.forwardRef(function NativeSelect(_a, ref) {
	    var style = _a.style, className = _a.className, labelStyle = _a.labelStyle, labelClassName = _a.labelClassName, selectStyle = _a.selectStyle, selectClassName = _a.selectClassName, propIcon = _a.icon, propTheme = _a.theme, _b = _a.dense, dense = _b === void 0 ? false : _b, _c = _a.inline, inline = _c === void 0 ? false : _c, _d = _a.error, error = _d === void 0 ? false : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, label = _a.label, propOnBlur = _a.onBlur, propOnFocus = _a.onFocus, propOnChange = _a.onChange, containerRef = _a.containerRef, isLeftAddon = _a.isLeftAddon, isRightAddon = _a.isRightAddon, leftChildren = _a.leftChildren, rightChildren = _a.rightChildren, propUnderlineDirection = _a.underlineDirection, children = _a.children, props = __rest$1w(_a, ["style", "className", "labelStyle", "labelClassName", "selectStyle", "selectClassName", "icon", "theme", "dense", "inline", "error", "disabled", "label", "onBlur", "onFocus", "onChange", "containerRef", "isLeftAddon", "isRightAddon", "leftChildren", "rightChildren", "underlineDirection", "children"]);
	    ...
	    return (React__default['default'].createElement(TextFieldContainer, { style: style, className: classnames(container$1({
	            multi: multiple,
	        ...
	        React__default['default'].createElement(FloatingLabel, { style: labelStyle, className: classnames(block$Q("label"), labelClassName), htmlFor: id, error: error, active: valued && focused, valued: valued, floating: valued || multiple, dense: dense, disabled: disabled }, label),
	        React__default['default'].createElement("select", __assign$1M({}, props, { ref: ref, style: selectStyle, className: classnames(block$Q({
	                icon: icon,
	                multi: multiple,
	...
	var reducer = function (state, action) {
	    switch (action) {
	        ...
	        case EXITING:
	        case EXITED:
	            return __assign$1L(__assign$1L({}, state), { rendered: true, stage: action });
	        case ENTERED:
	...
	function Collapse(_a) {
	    ...
	    return React.cloneElement(child, __assign$1K(__assign$1K({}, transitionProps), { style: transitionStyle ? __assign$1K(__assign$1K({}, transitionStyle), childStyle) : childStyle, className: classnames(transitionProps.className, child.props.className) }));
	}
	...
	var CrossFade = React.forwardRef(function CrossFade(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement("div", __assign$1J({}, props, { className: className, ref: ref }), children));
	});
	...
	function ScaleTransition(_a) {
	    var visible = _a.visible, children = _a.children, propClassNames = _a.classNames, _b = _a.vertical, vertical = _b === void 0 ? false : _b, _c = _a.timeout, timeout = _c === void 0 ? SCALE_TIMEOUT : _c, _d = _a.portal, portal = _d === void 0 ? false : _d, portalInto = _a.portalInto, portalIntoId = _a.portalIntoId, _e = _a.mountOnEnter, mountOnEnter = _e === void 0 ? true : _e, _f = _a.unmountOnExit, unmountOnExit = _f === void 0 ? true : _f, props = __rest$1u(_a, ["visible", "children", "classNames", "vertical", "timeout", "portal", "portalInto", "portalIntoId", "mountOnEnter", "unmountOnExit"]);
	    var classNames = propClassNames;
	    if (!classNames) {
	        classNames = vertical ? SCALE_Y_CLASSNAMES : SCALE_CLASSNAMES;
	    }
	    return (React__default['default'].createElement(ConditionalPortal, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId },
	        React__default['default'].createElement(CSSTransition, __assign$1I({}, props, { in: visible, timeout: timeout, classNames: classNames, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit }), children)));
	}
	...
	function useFixedPositioning(_a) {
	    ...
	    var updateStyle = React.useCallback(function (nextElement) {
	        ...
	        var opts = __assign$1H({ initialX: initialX,
	            initialY: initialY,
	            xMargin: xMargin,
	            vwMargin: vwMargin,
	            yMargin: yMargin,
	    ...
	    return {
	        style: __assign$1H(__assign$1H({}, style), propStyle),
	...
	var Option = React.forwardRef(function Option(_a, ref) {
	    var className = _a.className, _b = _a.selected, selected = _b === void 0 ? false : _b, focused = _a.focused, children = _a.children, _c = _a.textChildren, textChildren = _c === void 0 ? true : _c, props = __rest$1t(_a, ["className", "selected", "focused", "children", "textChildren"]);
	    return (React__default['default'].createElement(SimpleListItem, __assign$1G({}, props, { ref: ref, role: "option", "aria-selected": selected || undefined, clickable: true, className: classnames(block$P({
	            selected: selected,
	            focused: focused,
	...
	var Listbox = React.forwardRef(function Listbox(_a, ref) {
	    ...
	    var _l = useActiveDescendantMovement(__assign$1F(__assign$1F({}, VERTICAL_LISTBOX), { defaultFocusedIndex: getIndex, items: options, baseId: id, valueKey: labelKey, getId: getOptionId$1, getItemValue: function (option, key) {
	            if (!isListboxOptionProps(option)) {
	                return "" + option;
	            }
	    ...
	    return (React__default['default'].createElement(ScaleTransition, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId, visible: !temporary || visible, vertical: true, timeout: timeout, classNames: classNames, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited },
	        React__default['default'].createElement(List, __assign$1F({}, props, { "aria-activedescendant": activeId, ref: ref, role: "listbox", tabIndex: tabIndex, className: classnames(block$O({ temporary: temporary }), className), onFocus: handleFocus, onKeyDown: onKeyDown }), options.map(function (option, i) {
	            ...
	            return (React__default['default'].createElement(Option, __assign$1F({ key: optionValue, id: optionId, disabled: disabled }, optionProps, { ref: itemRefs[i], focused: optionId === activeId, selected: value === optionValue, onClick: onClick }), optionLabel));
	        }))));
	});
	...
	var Select = React.forwardRef(function Select(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        React__default['default'].createElement(TextFieldContainer, __assign$1E({}, props, { "aria-haspopup": "listbox", "aria-disabled": disabled || undefined, ref: refHandler, role: "button", dense: dense, tabIndex: disabled ? undefined : 0, label: !!label, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: disabled ? undefined : handleKeyDown, onClick: disabled ? undefined : handleClick, theme: theme, error: error, active: focused || visible, inline: inline, disabled: disabled, underlineDirection: underlineDirection, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, rightChildren: rightChildren, className: classnames(block$N({ disabled: disabled }), className) }),
	            React__default['default'].createElement(FloatingLabel, { id: labelId, style: labelStyle, className: classnames(block$N("label"), labelClassName), htmlFor: id, error: error, active: valued && (focused || visible), valued: valued, floating: focused || valued || visible, dense: dense, disabled: disabled, component: "span" }, label),
	            React__default['default'].createElement("span", { id: displayValueId, style: displayLabelStyle, className: classnames(block$N("value", {
	                    disabled: disabled,
	                    readonly: readOnly,
	...
	var styles$8 = bem("rmd-slider-container");
	/**
	...
	var SliderContainer = React.forwardRef(function SliderContainer(_a, ref) {
	    var className = _a.className, beforeAddon = _a.beforeAddon, afterAddon = _a.afterAddon, children = _a.children, _b = _a.vertical, vertical = _b === void 0 ? false : _b, label = _a.label, labelId = _a.labelId, labelProps = _a.labelProps, _c = _a.disabled, disabled = _c === void 0 ? false : _c, props = __rest$1q(_a, ["className", "beforeAddon", "afterAddon", "children", "vertical", "label", "labelId", "labelProps", "disabled"]);
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        label && (React__default['default'].createElement("span", __assign$1D({}, labelProps, { id: labelId, className: classnames(labelStyles({ disabled: disabled }), labelProps === null || labelProps === void 0 ? void 0 : labelProps.className) }), label)),
	        React__default['default'].createElement("div", __assign$1D({}, props, { ref: ref, className: classnames(styles$8({
	                h: !vertical,
	...
	var Tooltip = React.forwardRef(function Tooltip(_a, ref) {
	    ...
	    return (React__default['default'].createElement(ConditionalPortal, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId },
	        React__default['default'].createElement(CSSTransition, { classNames: classNames, in: visible, timeout: timeout, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit },
	            React__default['default'].createElement("span", __assign$1C({}, props, { ref: ref, role: "tooltip", className: classnames(block$M((_b = {
	                        dense: dense,
	                        "line-wrap": lineWrap,
	...
	function useTooltip(_a) {
	    ...
	    }), visible = _p.visible, setVisible = _p.setVisible, mouseHandlers = _p.handlers, disableHoverMode = _p.disableHoverMode, others = __rest$1o(_p, ["visible", "setVisible", "handlers", "disableHoverMode"]);
	    ...
	    var _q = useFixedPositioning({
	        ...
	        onEntered: onEntered,
	        onExited: onExited,
	    }), positionProps = __rest$1o(_q, ["updateStyle"]);
	    var tooltipHandlers = __assign$1B(__assign$1B({}, mouseHandlers), { onFocus: onFocus,
	        onBlur: onBlur,
	        onKeyDown: onKeyDown,
	        onTouchStart: onTouchStart,
	        onContextMenu: onContextMenu });
	    var tooltipId = baseId + "-tooltip";
	    var elementProps = __assign$1B({ id: baseId, "aria-describedby": classnames(visible && tooltipId, describedBy) || undefined }, tooltipHandlers);
	    var tooltipProps = __assign$1B({ id: tooltipId, dense: dense,
	        visible: visible,
	        position: position }, positionProps);
	    return __assign$1B(__assign$1B({}, others), { visible: visible,
	...
	function Tooltipped(_a) {
	    ...
	    var tooltip = (React__default['default'].createElement(Tooltip, __assign$1A({}, tooltipProps, props, { mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit }), tooltipChildren));
	    if (typeof children === "function") {
	        return children(__assign$1A(__assign$1A({}, elementProps), { tooltip: tooltip }));
	    }
	    var child = React.Children.only(children);
	...
	var styles$7 = bem("rmd-slider-value");
	...
	function SliderValue(_a) {
	    var _b;
	    var index = _a.index, animate = _a.animate, discrete = _a.discrete, vertical = _a.vertical, children = _a.children, className = _a.className, _c = _a.portal, portal = _c === void 0 ? false : _c, props = __rest$1m(_a, ["index", "animate", "discrete", "vertical", "children", "className", "portal"]);
	    if (!discrete) {
	        return null;
	    }
	    return (React__default['default'].createElement(Tooltip, __assign$1z({}, props, { portal: portal, className: classnames(styles$7({
	            h: !vertical,
	            v: vertical,
	        }), (_b = {
	...
	var styles$6 = bem("rmd-slider-thumb");
	/**
	...
	var SliderThumb = React.forwardRef(function SliderThumb(_a, ref) {
	    ...
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        disabled && (React__default['default'].createElement("span", { className: classnames(styles$6(__assign$1y(__assign$1y({}, styleOptions), { mask: true, "mask-h": !vertical, "mask-v": vertical })), className) })),
	        React__default['default'].createElement("span", __assign$1y({}, props, { id: id, ref: ref, role: "slider", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, "aria-valuetext": getValueText(value) || undefined, "aria-disabled": disabled || undefined, "aria-orientation": (vertical && "vertical") || undefined, tabIndex: tabIndex, onBlur: onBlur, onFocus: onFocus, className: classnames(styles$6(__assign$1y(__assign$1y({}, styleOptions), { "disabled-h": disabled && !vertical, "disabled-v": disabled && vertical })), className) })),
	...
	var styles$5 = bem("rmd-slider-track");
	/**
	...
	var SliderTrack = React.forwardRef(function SliderTrack(_a, ref) {
	    var _b;
	    var propStyle = _a.style, className = _a.className, children = _a.children, _c = _a.animate, animate = _c === void 0 ? false : _c, _d = _a.vertical, vertical = _d === void 0 ? false : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, thumb1Percentage = _a.thumb1Percentage, thumb2Percentage = _a.thumb2Percentage, props = __rest$1k(_a, ["style", "className", "children", "animate", "vertical", "disabled", "thumb1Percentage", "thumb2Percentage"]);
	    var style = __assign$1x(__assign$1x({}, propStyle), (_b = {}, _b[THUMB_1_VAR] = thumb1Percentage, _b[THUMB_2_VAR] = thumb2Percentage, _b));
	    return (React__default['default'].createElement("span", __assign$1x({}, props, { ref: ref, style: style, className: classnames(styles$5({
	            animate: animate,
	            hoverable: !disabled,
	            disabled: disabled,
	            h: !vertical,
	...
	function useSliderControls(_a) {
	    var _b, _c;
	    var ref = _a.ref, propThumb1Ref = _a.thumb1Ref, propThumb2Ref = _a.thumb2Ref, min = _a.min, max = _a.max, step = _a.step, _d = _a.disabled, disabled = _d === void 0 ? false : _d, _e = _a.vertical, vertical = _e === void 0 ? false : _e, onBlur = _a.onBlur, onKeyDown = _a.onKeyDown, onMouseDown = _a.onMouseDown, onTouchStart = _a.onTouchStart, _f = _a.animationDuration, animationDuration = _f === void 0 ? DEFAULT_SLIDER_ANIMATION_TIME : _f, controls = __rest$1j(_a, ["ref", "thumb1Ref", "thumb2Ref", "min", "max", "step", "disabled", "vertical", "onBlur", "onKeyDown", "onMouseDown", "onTouchStart", "animationDuration"]);
	    ...
	    var drag = React.useCallback(function (event) {
	        ...
	        if (isRangeSlider(controls)) {
	            ...
	            var _c = getDragValue(__assign$1w(__assign$1w({}, options), { minValue: index === 0 ? min : thumb1Value_1 + step, maxValue: index === 1 ? max : thumb2Value_1 - step })), value = _c.value, current = _c.current;
	...
	var Slider = React.forwardRef(function Slider(_a, ref) {
	    ...
	    var _g = useSliderControls({
	        ...
	        persist: persist,
	        setValue: setValue,
	    }), thumb1Ref = _g.thumb1Ref, thumb1Value = _g.thumb1Value, dragging = _g.dragging, draggingIndex = _g.draggingIndex, onKeyDown = _g.onKeyDown, trackProps = __rest$1i(_g, ["thumb1Ref", "thumb1Value", "thumb2Ref", "thumb2Value", "dragging", "draggingIndex", "onKeyDown"]);
	    var labelId = "";
	    if (label) {
	        labelId = (labelProps === null || labelProps === void 0 ? void 0 : labelProps.id) || baseId + "-label";
	    }
	    return (React__default['default'].createElement(SliderContainer, __assign$1v({}, props, { ref: ref, label: label, labelId: labelId, labelProps: labelProps, disabled: disabled, vertical: vertical }),
	        React__default['default'].createElement(SliderTrack, __assign$1v({ id: baseId }, propTrackProps, trackProps, { animate: !dragging, disabled: disabled, vertical: vertical }),
	            React__default['default'].createElement(SliderThumb, __assign$1v({}, thumbProps, { "aria-label": thumbLabel, "aria-labelledby": thumbLabelledBy || labelId, baseId: baseId, ref: thumb1Ref, getValueText: getValueText, min: min, max: max, discrete: discrete, disabled: disabled, vertical: vertical, animate: !dragging, animationDuration: animationDuration, value: thumb1Value, index: 0, active: draggingIndex === 0, onKeyDown: onKeyDown })))));
	});
	...
	var RangeSlider = React.forwardRef(function RangeSlider(_a, ref) {
	    ...
	    var _j = useSliderControls({
	        ...
	        persist: persist,
	        setValue: setValue,
	    }), thumb1Ref = _j.thumb1Ref, thumb1Value = _j.thumb1Value, thumb2Ref = _j.thumb2Ref, thumb2Value = _j.thumb2Value, dragging = _j.dragging, draggingIndex = _j.draggingIndex, onKeyDown = _j.onKeyDown, trackProps = __rest$1h(_j, ["thumb1Ref", "thumb1Value", "thumb2Ref", "thumb2Value", "dragging", "draggingIndex", "onKeyDown"]);
	    ...
	    return (React__default['default'].createElement(SliderContainer, __assign$1u({}, props, { ref: ref, label: label, labelId: labelId, labelProps: labelProps, disabled: disabled, vertical: vertical }),
	        React__default['default'].createElement(SliderTrack, __assign$1u({ id: baseId }, propTrackProps, trackProps, { animate: !dragging, disabled: disabled, vertical: vertical }),
	            React__default['default'].createElement(SliderThumb, __assign$1u({ "aria-label": thumb1Label, "aria-labelledby": thumb1LabelledBy }, thumb1Props, thumbProps, { ref: thumb1Ref, value: thumb1Value, index: 0, active: draggingIndex === 0, onKeyDown: thumb1KeyDown })),
	            React__default['default'].createElement(SliderThumb, __assign$1u({ "aria-label": thumb2Label, "aria-labelledby": thumb2LabelledBy }, thumb2Props, thumbProps, { ref: thumb2Ref, value: thumb2Value, index: 1, active: draggingIndex === 1, onKeyDown: thumb2KeyDown })))));
	});
	...
	var TextField = React.forwardRef(function TextField(_a, ref) {
	    var style = _a.style, className = _a.className, inputStyle = _a.inputStyle, inputClassName = _a.inputClassName, label = _a.label, labelStyle = _a.labelStyle, labelClassName = _a.labelClassName, _b = _a.type, type = _b === void 0 ? "text" : _b, propTheme = _a.theme, _c = _a.dense, dense = _c === void 0 ? false : _c, _d = _a.inline, inline = _d === void 0 ? false : _d, _e = _a.error, error = _e === void 0 ? false : _e, _f = _a.disabled, disabled = _f === void 0 ? false : _f, propOnBlur = _a.onBlur, propOnFocus = _a.onFocus, propOnChange = _a.onChange, containerRef = _a.containerRef, _g = _a.isLeftAddon, isLeftAddon = _g === void 0 ? true : _g, _h = _a.isRightAddon, isRightAddon = _h === void 0 ? true : _h, leftChildren = _a.leftChildren, rightChildren = _a.rightChildren, propUnderlineDirection = _a.underlineDirection, containerProps = _a.containerProps, props = __rest$1g(_a, ["style", "className", "inputStyle", "inputClassName", "label", "labelStyle", "labelClassName", "type", "theme", "dense", "inline", "error", "disabled", "onBlur", "onFocus", "onChange", "containerRef", "isLeftAddon", "isRightAddon", "leftChildren", "rightChildren", "underlineDirection", "containerProps"]);
	    ...
	    return (React__default['default'].createElement(TextFieldContainer, __assign$1t({}, containerProps, { style: style, className: className, ref: containerRef, theme: theme, error: error, active: focused, label: !!label, dense: dense, inline: inline, disabled: disabled, isLeftAddon: isLeftAddon, isRightAddon: isRightAddon, leftChildren: leftChildren, rightChildren: rightChildren, underlineDirection: underlineDirection }),
	        ...
	        React__default['default'].createElement("input", __assign$1t({}, props, { ref: ref, type: type, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange, style: inputStyle, className: classnames(block$L({
	                floating: label && theme !== "none",
	            }), inputClassName) }))));
	});
	...
	var Password = React.forwardRef(function Password(_a, ref) {
	    ...
	    if (!disableVisibility) {
	        rightChildren = (React__default['default'].createElement(Button, { id: id + "-password-toggle", "aria-label": visibilityLabel, "aria-pressed": visible, buttonType: "icon", onClick: toggle, style: visibilityStyle, className: classnames(block$K("toggle"), visibilityClassName) }, typeof getVisibilityIcon === "function"
	            ? getVisibilityIcon(type)
	            : visibilityIcon));
	    }
	    return (React__default['default'].createElement(TextField, __assign$1s({}, props, { className: classnames(block$K({ offset: !disableVisibility }), className), inputClassName: classnames(block$K("input", { offset: !disableVisibility }), inputClassName), ref: ref, type: type, isRightAddon: isRightAddon, rightChildren: rightChildren })));
	});
	...
	var TextArea = React.forwardRef(function TextArea(_a, forwardedRef) {
	    ...
	    var area = (React__default['default'].createElement("textarea", __assign$1r({}, props, { ref: refHandler, rows: rows, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: onChange, style: __assign$1r(__assign$1r({}, areaStyle), { height: height }), className: classnames(block$J({
	    ...
	    if (resize === "auto") {
	        children = (React__default['default'].createElement("div", { style: { height: height }, className: container("inner", { animate: animate }) },
	            area,
	            React__default['default'].createElement("textarea", { "aria-hidden": true, defaultValue: value || defaultValue, id: id + "-mask", ref: maskRefHandler, readOnly: true, rows: rows, tabIndex: -1, style: areaStyle, className: classnames(block$J({
	                    rn: true,
	                    mask: true,
	                    floating: label && theme !== "none",
	                }), areaClassName) })));
	    ...
	    return (React__default['default'].createElement(TextFieldContainer, __assign$1r({}, containerProps, { style: __assign$1r(__assign$1r({}, style), { height: height
	                ? "calc(" + PADDING_VARIABLES + " + " + height + "px)"
	                : undefined }), className: classnames(container({
	...
	var TextFieldWithMessage = React.forwardRef(function TextFieldWithMessage(_a, ref) {
	    ...
	    return (React__default['default'].createElement(FormMessageContainer, __assign$1q({}, messageContainerProps, { messageProps: messageProps }),
	        React__default['default'].createElement(TextField, __assign$1q({}, props, { ref: ref }))));
	});
	...
	var TextAreaWithMessage = React.forwardRef(function TextAreaWithMessage(_a, ref) {
	    ...
	    return (React__default['default'].createElement(FormMessageContainer, __assign$1p({}, messageContainerProps, { messageProps: messageProps }),
	        React__default['default'].createElement(TextArea, __assign$1p({}, props, { ref: ref }))));
	});
	...
	var PasswordWithMessage = React.forwardRef(function PasswordWithMessage(_a, ref) {
	    var messageProps = _a.messageProps, messageContainerProps = _a.messageContainerProps, props = __rest$1b(_a, ["messageProps", "messageContainerProps"]);
	    return (React__default['default'].createElement(FormMessageContainer, __assign$1o({}, messageContainerProps, { messageProps: messageProps }),
	        React__default['default'].createElement(Password, __assign$1o({}, props, { ref: ref }))));
	});
	...
	function useTextField(_a) {
	    ...
	    var updateState = React.useCallback(function (field, isBlurEvent) {
	        ...
	        var error = isErrored(__assign$1n(__assign$1n({}, options), { errorMessage: errorMessage }));
	    ...
	    var handleChange = React.useCallback(function (event) {
	        ...
	        if (!validateOnChange ||
	            ...
	            setState(function (prevState) { return (__assign$1n(__assign$1n({}, prevState), { value: event.currentTarget.value })); });
	            return;
	        }
	    ...
	    var updateNumber = React.useCallback(function (value) {
	        if (typeof value === "function") {
	            setNumber(function (prevNumber) {
	                ...
	                setState(function (prevState) { return (__assign$1m(__assign$1m({}, prevState), { value: "" + (updated !== null && updated !== void 0 ? updated : "") })); });
	                return updated;
	            });
	            return;
	        }
	        setNumber(value);
	        setState(function (prevState) { return (__assign$1m(__assign$1m({}, prevState), { value: "" + (value !== null && value !== void 0 ? value : "") })); });
	    }, [setState]);
	    return [
	        number,
	        __assign$1m(__assign$1m({}, props), { min: min, max: max, step: step, type: "number" }),
	        {
	            reset: reset,
	...
	var ToggleContainer = React.forwardRef(function ToggleContainer(_a, ref) {
	    var className = _a.className, _b = _a.inline, inline = _b === void 0 ? false : _b, _c = _a.stacked, stacked = _c === void 0 ? false : _c, children = _a.children, props = __rest$1a(_a, ["className", "inline", "stacked", "children"]);
	    return (React__default['default'].createElement("div", __assign$1l({}, props, { ref: ref, className: classnames(block$I({ stacked: stacked, inline: inline }), className) }), children));
	});
	...
	var InputToggle = React.forwardRef(function InputToggle(allProps, ref) {
	    ...
	    return (React__default['default'].createElement(ToggleContainer, { style: style, className: className, inline: inline, stacked: stacked },
	        iconAfter && labelEl,
	        React__default['default'].createElement("span", { style: toggleStyle, className: classnames(block$H({
	                focused: focused,
	                disabled: disabled,
	            }), toggleClassName) },
	            React__default['default'].createElement("input", __assign$1k({}, props, handlers, { ref: ref, style: inputStyle, disabled: disabled, onFocus: onFocus, onBlur: onBlur, className: classnames(block$H("input"), inputClassName) })),
	...
	var Checkbox = React.forwardRef(function Checkbox(_a, ref) {
	    var propIcon = _a.icon, _b = _a.indeterminate, indeterminate = _b === void 0 ? false : _b, props = __rest$18(_a, ["icon", "indeterminate"]);
	    var icon = useIcon("checkbox", propIcon);
	    return (React__default['default'].createElement(InputToggle, __assign$1j({}, props, { icon: icon, ref: ref, type: "checkbox", indeterminate: indeterminate })));
	});
	...
	var Radio = React.forwardRef(function Radio(_a, ref) {
	    var propIcon = _a.icon, props = __rest$17(_a, ["icon"]);
	    var icon = useIcon("radio", propIcon);
	    return React__default['default'].createElement(InputToggle, __assign$1i({}, props, { icon: icon, ref: ref, type: "radio" }));
	});
	...
	var Switch = React.forwardRef(function Switch(_a, ref) {
	    var style = _a.style, className = _a.className, ballStyle = _a.ballStyle, ballClassName = _a.ballClassName, trackStyle = _a.trackStyle, trackClassName = _a.trackClassName, label = _a.label, labelStyle = _a.labelStyle, labelClassName = _a.labelClassName, labelDisabled = _a.labelDisabled, _b = _a.error, error = _b === void 0 ? false : _b, _c = _a.disabled, disabled = _c === void 0 ? false : _c, _d = _a.stacked, stacked = _d === void 0 ? false : _d, _e = _a.inline, inline = _e === void 0 ? false : _e, _f = _a.iconAfter, iconAfter = _f === void 0 ? false : _f, children = _a.children, props = __rest$16(_a, ["style", "className", "ballStyle", "ballClassName", "trackStyle", "trackClassName", "label", "labelStyle", "labelClassName", "labelDisabled", "error", "disabled", "stacked", "inline", "iconAfter", "children"]);
	    var id = props.id;
	    return (React__default['default'].createElement(ToggleContainer, { style: style, className: classnames("rmd-switch-container", className), inline: inline, stacked: stacked },
	        React__default['default'].createElement(TextIconSpacing, { icon: React__default['default'].createElement(Label, { style: labelStyle, className: labelClassName, htmlFor: id, error: error, disabled: labelDisabled !== null && labelDisabled !== void 0 ? labelDisabled : disabled }, label), iconAfter: !iconAfter },
	            React__default['default'].createElement(SwitchTrack, __assign$1h({}, props, { ref: ref, style: trackStyle, className: trackClassName, disabled: disabled, ballStyle: ballStyle, ballClassName: ballClassName }), children))));
	});
	...
	var LinearProgress = React.forwardRef(function LinearProgress(_a, ref) {
	    var propStyle = _a.style, className = _a.className, propBarStyle = _a.barStyle, barClassName = _a.barClassName, _b = _a.min, min = _b === void 0 ? 0 : _b, _c = _a.max, max = _c === void 0 ? 100 : _c, value = _a.value, _d = _a.reverse, reverse = _d === void 0 ? false : _d, _e = _a.animate, animate = _e === void 0 ? true : _e, _f = _a.vertical, vertical = _f === void 0 ? false : _f, _g = _a.verticalHeight, verticalHeight = _g === void 0 ? 240 : _g, props = __rest$15(_a, ["style", "className", "barStyle", "barClassName", "min", "max", "value", "reverse", "animate", "vertical", "verticalHeight"]);
	    var style = React.useMemo(function () {
	        if (!vertical || verticalHeight === null) {
	            return propStyle;
	        }
	        return __assign$1g(__assign$1g({}, propStyle), { height: verticalHeight });
	    ...
	    var barStyle = React.useMemo(function () {
	        ...
	        return __assign$1g(__assign$1g({}, propBarStyle), (_a = {}, _a[key] = progress * 100 + "%", _a));
	    }, [progress, propBarStyle, vertical]);
	    var determinate = typeof progress === "number";
	    var indeterminate = !determinate;
	    return (React__default['default'].createElement("span", __assign$1g({}, props, { ref: ref, style: style, role: "progressbar", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, className: classnames(block$G({
	            vertical: vertical,
	            determinate: determinate,
	            indeterminate: indeterminate,
	        }), className) }),
	        React__default['default'].createElement("span", { style: barStyle, className: classnames(block$G("bar", {
	                vertical: vertical,
	...
	var CircularProgress = React.forwardRef(function CircularProgress(_a, ref) {
	    ...
	    var svgStyle = React.useMemo(function () {
	        ...
	        return __assign$1f(__assign$1f({}, propSvgStyle), { WebkitTransform: transform, transform: transform });
	    }, [progress, maxRotation, propSvgStyle]);
	    var circleStyle = React.useMemo(function () {
	        if (typeof progress !== "number") {
	            return propCircleStyle;
	        }
	        return __assign$1f(__assign$1f({}, propCircleStyle), { strokeDashoffset: dashoffset - dashoffset * progress });
	    }, [progress, propCircleStyle, dashoffset]);
	    var determinate = typeof progress === "number";
	    var indeterminate = !determinate;
	    return (React__default['default'].createElement("span", __assign$1f({}, props, { ref: ref, role: "progressbar", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, className: classnames(block$F({ centered: centered, small: small }), className) }),
	        React__default['default'].createElement("svg", { style: svgStyle, className: classnames(block$F("svg", {
	                animate: animate && determinate,
	                determinate: determinate,
	                indeterminate: indeterminate,
	            }), svgClassName), viewBox: viewBox },
	            React__default['default'].createElement("circle", { style: circleStyle, className: classnames(block$F("circle", {
	                    animate: animate && determinate,
	                    determinate: determinate,
	                    indeterminate: indeterminate,
	...
	var AsyncSwitch = React.forwardRef(function AsyncSwitch(_a, ref) {
	    var id = _a.id, disabled = _a.disabled, className = _a.className, progressStyle = _a.progressStyle, progressClassName = _a.progressClassName, loading = _a.loading, onChange = _a.onChange, props = __rest$13(_a, ["id", "disabled", "className", "progressStyle", "progressClassName", "loading", "onChange"]);
	    var progressId = id + "-loading";
	    return (React__default['default'].createElement(Switch, __assign$1e({}, props, getProgressA11y(progressId, loading), { id: id, ref: ref, disabled: disabled, className: classnames("rmd-switch--async", className), labelDisabled: disabled || false, onChange: loading ? noop$3 : onChange }), loading && (React__default['default'].createElement(CircularProgress, { id: progressId, style: progressStyle, className: classnames("rmd-switch__progress", progressClassName), centered: false }))));
	});
	/* istanbul ignore next */
	{
	    try {
	...
	function HighlightedResult(_a) {
	    ...
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        ...
	        React__default['default'].createElement("span", { id: id, style: style, className: classnames("rmd-typography--bold", className) }, children.substring(i, end)),
	...
	function useAutoComplete(_a) {
	    ...
	    var _e = React.useState(function () {
	        var _a;
	        var options = __assign$1d(__assign$1d({}, filterOptions), { valueKey: valueKey, getItemValue: getResultValue, startsWith: (_a = filterOptions === null || filterOptions === void 0 ? void 0 : filterOptions.startsWith) !== null && _a !== void 0 ? _a : isInlineAutocomplete });
	    ...
	    var setValue = React.useCallback(function (nextValue) {
	        ...
	        if (nextValue || filterOnNoValue) {
	            var options = __assign$1d(__assign$1d({}, filterOptions), { valueKey: valueKey, getItemValue: getResultValue, startsWith: startsWith });
	    ...
	    var _h = useActiveDescendantMovement(__assign$1d(__assign$1d({}, VERTICAL_COMBOBOX), { getId: getResultId, items: filteredData, baseId: suggestionsId, onChange: function (_a, itemRefs) {
	            ...
	            setState(function (prevState) { return (__assign$1d(__assign$1d({}, prevState), { value: nextMatch, match: nextMatch })); });
	        },
	        onKeyDown: function (event) {
	            if (onKeyDown) {
	                onKeyDown(event);
	    ...
	    return {
	        ...
	        itemRefs: itemRefs,
	        filteredData: filteredData,
	        fixedStyle: __assign$1d(__assign$1d({}, style), listboxStyle),
	        transitionHooks: {
	            onEnter: onEnter,
	            onEntering: onEntering,
	            onEntered: onEntered,
	...
	var AutoComplete = React.forwardRef(function AutoComplete(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        React__default['default'].createElement(TextField, __assign$1c({}, props, { "aria-autocomplete": autoComplete, "aria-controls": comboboxId, "aria-activedescendant": activeId, autoComplete: "off", value: propValue !== null && propValue !== void 0 ? propValue : match, onBlur: handleBlur, onFocus: handleFocus, onClick: handleClick, onKeyDown: handleKeyDown, onChange: handleChange, ref: ref, className: classnames(block$E(), className), containerProps: __assign$1c(__assign$1c({}, containerProps), { "aria-haspopup": "listbox", "aria-owns": suggestionsId, "aria-expanded": visible, id: comboboxId, role: "combobox" }) })),
	        React__default['default'].createElement(ScaleTransition, __assign$1c({ portal: portal, portalInto: portalInto, portalIntoId: portalIntoId, vertical: true, visible: visible }, transitionHooks),
	            React__default['default'].createElement(List, { id: suggestionsId, role: "listbox", ref: listboxRef, style: fixedStyle, className: classnames(listbox({ temporary: true }), listboxClassName) },
	                ...
	                filteredData.map(function (datum, i) {
	                    ...
	                    return (React__default['default'].createElement(Option, __assign$1c({ key: resultId }, optionProps, { id: resultId, selected: false, focused: resultId === activeId, ref: itemRefs[i], onClick: function () { return handleAutoComplete(i); } }),
	...
	var Avatar = React.forwardRef(function Avatar(_a, ref) {
	    var _b;
	    var className = _a.className, children = _a.children, src = _a.src, _c = _a.alt, alt = _c === void 0 ? "" : _c, _d = _a.color, color = _d === void 0 ? "" : _d, imgProps = _a.imgProps, referrerPolicy = _a.referrerPolicy, props = __rest$11(_a, ["className", "children", "src", "alt", "color", "imgProps", "referrerPolicy"]);
	    var img;
	    if (src || imgProps) {
	        img = (React__default['default'].createElement("img", __assign$1b({ src: src, alt: alt, referrerPolicy: referrerPolicy }, imgProps, { className: classnames(block$D("image"), imgProps === null || imgProps === void 0 ? void 0 : imgProps.className) })));
	    }
	    return (React__default['default'].createElement("span", __assign$1b({}, props, { ref: ref, className: classnames(block$D((_b = {}, _b[color] = color, _b)), className) }),
	        img,
	        children));
	});
	...
	var Badge = React.forwardRef(function Badge(_a, ref) {
	    var _b;
	    var className = _a.className, _c = _a.theme, theme = _c === void 0 ? "default" : _c, _d = _a.children, children = _d === void 0 ? null : _d, _e = _a.disableNullOnZero, disableNullOnZero = _e === void 0 ? false : _e, props = __rest$10(_a, ["className", "theme", "children", "disableNullOnZero"]);
	    if (isEmpty(children, disableNullOnZero)) {
	        return null;
	    }
	    return (React__default['default'].createElement("span", __assign$1a({}, props, { ref: ref, className: classnames(block$C((_b = {}, _b[theme] = theme !== "clear", _b)), className) }), children));
	});
	...
	var BadgeContainer = React.forwardRef(function BadgeContainer(_a, ref) {
	    ...
	    return (React__default['default'].createElement("span", __assign$19({}, props, { className: classnames(block$B(), className), ref: ref }), children));
	});
	...
	var BadgedButton = React.forwardRef(function BadgedButton(_a, ref) {
	    var _b = _a["aria-label"], ariaLabel = _b === void 0 ? "Notifications" : _b, badgeStyle = _a.badgeStyle, badgeClassName = _a.badgeClassName, badgeRef = _a.badgeRef, propBadgeId = _a.badgeId, propButtonChildren = _a.buttonChildren, _c = _a.buttonType, buttonType = _c === void 0 ? "icon" : _c, badgeTheme = _a.badgeTheme, _d = _a.children, children = _d === void 0 ? null : _d, _e = _a.disableNullOnZero, disableNullOnZero = _e === void 0 ? false : _e, propDescribedBy = _a["aria-describedby"], props = __rest$_(_a, ["aria-label", "badgeStyle", "badgeClassName", "badgeRef", "badgeId", "buttonChildren", "buttonType", "badgeTheme", "children", "disableNullOnZero", "aria-describedby"]);
	    var id = props.id;
	    ...
	    if (!isEmpty(children, disableNullOnZero)) {
	        describedBy = classnames(describedBy, badgeId);
	    }
	    return (React__default['default'].createElement(Button, __assign$18({}, props, { "aria-label": ariaLabel, "aria-describedby": describedBy, ref: ref, buttonType: buttonType }),
	        buttonChildren,
	...
	var Card = React.forwardRef(function Card(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a.raiseable, raiseable = _b === void 0 ? false : _b, _c = _a.fullWidth, fullWidth = _c === void 0 ? false : _c, _d = _a.bordered, bordered = _d === void 0 ? false : _d, props = __rest$Z(_a, ["className", "children", "raiseable", "fullWidth", "bordered"]);
	    return (React__default['default'].createElement("div", __assign$17({}, props, { ref: ref, className: classnames(block$A({
	            bordered: bordered,
	            shadowed: !bordered,
	...
	function CardHeaderAddon(_a) {
	    var className = _a.className, children = _a.children, props = __rest$Y(_a, ["className", "children"]);
	    if (!children) {
	        return null;
	    }
	    return (React__default['default'].createElement("span", __assign$16({}, props, { className: classnames(block$z("header-addon"), className) }), children));
	}
	...
	var CardHeader = React.forwardRef(function CardHeader(_a, ref) {
	    var _b;
	    var _c = _a.align, align = _c === void 0 ? "center" : _c, className = _a.className, contentClassName = _a.contentClassName, children = _a.children, beforeChildren = _a.beforeChildren, afterChildren = _a.afterChildren, props = __rest$X(_a, ["align", "className", "contentClassName", "children", "beforeChildren", "afterChildren"]);
	    return (React__default['default'].createElement("header", __assign$15({}, props, { ref: ref, className: classnames(block$y("header", (_b = {},
	            _b[align] = align !== "none",
	            _b)), className) }),
	        React__default['default'].createElement(TextIconSpacing, { icon: React__default['default'].createElement(CardHeaderAddon, null, beforeChildren) },
	            React__default['default'].createElement(TextIconSpacing, { icon: React__default['default'].createElement(CardHeaderAddon, null, afterChildren), iconAfter: true },
	                React__default['default'].createElement("span", { className: classnames(block$y("header-content"), contentClassName) }, children)))));
	});
	...
	var CardTitle = React.forwardRef(function CardTitle(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a.small, small = _b === void 0 ? false : _b, _c = _a.noWrap, noWrap = _c === void 0 ? false : _c, props = __rest$W(_a, ["className", "children", "small", "noWrap"]);
	    return (React__default['default'].createElement("h5", __assign$14({}, props, { ref: ref, className: classnames(block$x("title", { small: small }), {
	...
	var CardSubtitle = React.forwardRef(function CardSubtitle(_a, ref) {
	    var className = _a.className, children = _a.children, _b = _a.noWrap, noWrap = _b === void 0 ? false : _b, _c = _a.disableSecondaryColor, disableSecondaryColor = _c === void 0 ? false : _c, props = __rest$V(_a, ["className", "children", "noWrap", "disableSecondaryColor"]);
	    return (React__default['default'].createElement("h6", __assign$13({}, props, { ref: ref, className: classnames(block$w("subtitle", {
	...
	var CardContent = React.forwardRef(function CardContent(_a, ref) {
	    var _b = _a.disablePadding, disablePadding = _b === void 0 ? false : _b, _c = _a.disableExtraPadding, disableExtraPadding = _c === void 0 ? false : _c, _d = _a.disableSecondaryColor, disableSecondaryColor = _d === void 0 ? false : _d, _e = _a.disableParagraphMargin, disableParagraphMargin = _e === void 0 ? false : _e, className = _a.className, children = _a.children, props = __rest$U(_a, ["disablePadding", "disableExtraPadding", "disableSecondaryColor", "disableParagraphMargin", "className", "children"]);
	    return (React__default['default'].createElement("div", __assign$12({}, props, { ref: ref, className: classnames(block$v("content", {
	...
	var CardActions = React.forwardRef(function CardActions(_a, ref) {
	    var _b;
	    var className = _a.className, _c = _a.align, align = _c === void 0 ? "end" : _c, children = _a.children, props = __rest$T(_a, ["className", "align", "children"]);
	    return (React__default['default'].createElement("div", __assign$11({}, props, { ref: ref, className: classnames(block$u("actions", (_b = {},
	            _b[align] = align !== "end",
	            _b)), className) }), children));
	});
	...
	var Chip = React.forwardRef(function Chip(_a, ref) {
	    ...
	    if (!disableContentWrap) {
	        content = (React__default['default'].createElement("span", { style: contentStyle, className: classnames(block$t("content"), contentClassName) }, children));
	    }
	    ...
	    return (React__default['default'].createElement(Component, __assign$10({}, (noninteractable ? {} : buttonProps), props, handlers, { ref: ref, className: classnames(block$t((_b = {},
	            _b[theme] = true,
	...
	var Dialog = React.forwardRef(function Dialog(_a, ref) {
	    ...
	    if (isCentered || forceContainer) {
	        ...
	        dialog = (React__default['default'].createElement("span", { id: id + "-container", style: containerStyle, className: classnames("rmd-dialog-container", containerClassName) }, dialog));
	    }
	...
	var DialogHeader = React.forwardRef(function DialogHeader(_a, ref) {
	    ...
	    return (React__default['default'].createElement("header", __assign$Z({}, props, { ref: ref, className: classnames(block$q("header"), className) }), children));
	});
	...
	var DialogTitle = React.forwardRef(function DialogTitle(_a, ref) {
	    var children = _a.children, className = _a.className, props = __rest$O(_a, ["children", "className"]);
	    return (React__default['default'].createElement("h2", __assign$Y({}, props, { ref: ref, className: classnames(block$p("title"), className) }), children));
	});
	...
	var DialogContent = React.forwardRef(function DialogContent(_a, ref) {
	    var children = _a.children, className = _a.className, _b = _a.disablePadding, disablePadding = _b === void 0 ? false : _b, props = __rest$N(_a, ["children", "className", "disablePadding"]);
	    return (React__default['default'].createElement("div", __assign$X({}, props, { ref: ref, className: classnames(block$o("content", {
	            padded: !disablePadding,
	        }), className) }), children));
	});
	...
	var DialogFooter = React.forwardRef(function DialogFooter(_a, ref) {
	    var _b;
	    var children = _a.children, className = _a.className, _c = _a.align, align = _c === void 0 ? "end" : _c, props = __rest$M(_a, ["children", "className", "align"]);
	    return (React__default['default'].createElement("footer", __assign$W({}, props, { ref: ref, className: classnames(block$n("footer", (_b = {
	                flex: align !== "none"
	            },
	            _b[align] = align !== "none",
	            _b)), className) }), children));
	...
	var FixedDialog = React.forwardRef(function FixedDialog(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Dialog, __assign$V({}, props, { ref: ref, type: "custom", style: style, className: classnames("rmd-dialog--fixed", className), classNames: classNames, overlayHidden: overlayHidden, disableScrollLock: disableScrollLock, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExited: onExited }), children));
	});
	...
	var Divider = React.forwardRef(function Divider(_a, ref) {
	    var _b = _a.inset, inset = _b === void 0 ? false : _b, _c = _a.vertical, vertical = _c === void 0 ? false : _c, _d = _a.role, role = _d === void 0 ? "separator" : _d, className = _a.className, props = __rest$K(_a, ["inset", "vertical", "role", "className"]);
	    var Component = (vertical ? "div" : "hr");
	    return (React__default['default'].createElement(Component, __assign$U({}, props, { ref: ref, role: role, className: classnames(block$m({ inset: !vertical && inset, vertical: vertical }), className) })));
	});
	...
	var VerticalDivider = React.forwardRef(function VerticalDivider(_a, forwardedRef) {
	    var style = _a.style, _b = _a.maxHeight, maxHeight = _b === void 0 ? 1 : _b, props = __rest$J(_a, ["style", "maxHeight"]);
	    var _c = useVerticalDividerHeight(maxHeight, forwardedRef), ref = _c.ref, height = _c.height;
	    return (React__default['default'].createElement(Divider, __assign$T({}, props, { style: __assign$T(__assign$T({}, style), { height: height }), ref: ref, vertical: true })));
	});
	...
	var ExpansionPanelHeader = React.forwardRef(function ExpansionPanelHeader(_a, ref) {
	    var propIcon = _a.icon, expanded = _a.expanded, children = _a.children, className = _a.className, _b = _a.disableTransition, disableTransition = _b === void 0 ? false : _b, props = __rest$I(_a, ["icon", "expanded", "children", "className", "disableTransition"]);
	    var icon = useIcon("expander", propIcon);
	    return (React__default['default'].createElement(UnstyledButton, __assign$S({}, props, { ref: ref, "aria-expanded": expanded || undefined, className: classnames(block$l("header"), className) }),
	        children,
	...
	var ExpansionList = React.forwardRef(function ExpansionList(_a, ref) {
	    var children = _a.children, props = __rest$G(_a, ["children"]);
	    return (React__default['default'].createElement("div", __assign$Q({}, props, { ref: ref }), children));
	});
	            ...
	            React__default['default'].createElement(NestedDialogContextProvider, null,
	                React__default['default'].createElement(UserInteractionModeListener, null,
	                    React__default['default'].createElement(StatesConfig, { disableRipple: disableRipple, disableProgrammaticRipple: disableProgrammaticRipple, rippleTimeout: rippleTimeout, rippleClassNames: rippleClassNames },
	                        React__default['default'].createElement(HoverModeProvider, __assign$P({ disabled: disableTooltipHoverMode, defaultVisibleInTime: tooltipDefaultDelay, deactivateTime: tooltipDelayTimeout }, hoverMode),
	                            React__default['default'].createElement(IconProvider, __assign$P({}, icons),
	                                React__default['default'].createElement(FormThemeProvider, __assign$P({}, formTheme), children)))))))));
	}
	...
	function TreeItemExpanderIcon(_a) {
	    var className = _a.className, children = _a.children, _b = _a.rotated, rotated = _b === void 0 ? false : _b, props = __rest$E(_a, ["className", "children", "rotated"]);
	    var icon = useIcon("expander", children);
	    return (React__default['default'].createElement(IconRotator, __assign$N({}, props, { rotated: rotated, className: classnames(block$j("rotator-icon"), className) }), icon));
	}
	...
	var TreeItem = React.forwardRef(function TreeItem(_a, ref) {
	    ...
	    var a11y = __assign$M(__assign$M({ "aria-expanded": renderChildItems ? expanded : undefined, "aria-level": depth + 1, "aria-setsize": listSize, "aria-posinset": itemIndex + 1, "aria-disabled": disabled ? "true" : undefined, id: id, role: "treeitem", tabIndex: -1 }, handlers), { onFocus: handleFocus });
	    var noA11y = { role: "none" };
	    return (React__default['default'].createElement("li", __assign$M({}, (isLink ? noA11y : a11y), { ref: liRef, style: liStyle, className: classnames(block$i(), liClassName) }),
	        React__default['default'].createElement(Content, __assign$M({}, props, (isLink ? a11y : undefined), { ref: ref, className: classnames(block$i("content", (_b = {
	                    link: isLink,
	...
	function defaultTreeItemRenderer(itemProps, item, treeProps) {
	    ...
	    var overrides = getItemProps(__assign$L(__assign$L({}, treeItem), { focused: focused,
	        selected: selected,
	        expanded: expanded }));
	    ...
	    return (React__default['default'].createElement(TreeItem, __assign$L({}, itemProps, { as: as, to: to, href: href, isLink: isLink, contentComponent: contentComponent, readOnly: readOnly, disabled: disabled, leftAddon: leftAddon, leftAddonType: leftAddonType, leftAddonPosition: leftAddonPosition, rightAddon: rightAddon, rightAddonType: rightAddonType, rightAddonPosition: rightAddonPosition, expanderLeft: expanderLeft, expanderIcon: expanderIcon, className: className, liClassName: liClassName }, overrides), children));
	}
	...
	function buildTree(parentId, items, sort) {
	    ...
	    while (i > 0) {
	        ...
	        if (items[i] && items[i].parentId === parentId) {
	            ...
	            // set
	            childItems.unshift(__assign$K({}, item));
	        }
	    }
	...
	function useTreeMovement(_a) {
	    ...
	    var isKeyboard = useIsUserInteractionMode("keyboard");
	    var _c = useActiveDescendantMovement(__assign$J(__assign$J({}, VERTICAL_TREE), { items: visibleItems, baseId: id, getId: function (_baseId, index) {
	...
	_a, ref) {
	        ...
	        return items.map(function (item, index) {
	            ...
	            return itemRenderer({
	                ...
	                renderChildItems: childItems
	                    ...
	                    : undefined,
	            }, __assign$I(__assign$I({}, item), { visibleIndex: visibleIndex }), __assign$I({ id: id,
	    ...
	    return (React__default['default'].createElement(List, __assign$I({}, props, { ref: ref, id: id, "aria-activedescendant": activeId, "aria-multiselectable": multiSelect || undefined, role: "tree", tabIndex: 0, className: classnames(block$h(), className), onBlur: handleBlur, onFocus: handleFocus, onKeyDown: handleKeyDown }), renderChildItems(items, 0, [])));
	});
	...
	var defaultMiniNavigationItemRenderer = function (itemProps, item, _a) {
	    ...
	    var key = itemProps.key, renderChildItems = itemProps.renderChildItems, props = __rest$B(itemProps, ["key", "renderChildItems"]);
	    ...
	    var focused = itemProps.focused, selected = itemProps.selected, expanded = itemProps.expanded;
	    var overrides = getItemProps(__assign$H(__assign$H({}, item), { focused: focused,
	        selected: selected,
	        expanded: expanded }));
	    var children = (overrides && overrides.children) || undefined;
	    if (typeof children === "undefined") {
	    ...
	    return (React__default['default'].createElement(TreeItem, __assign$H({ key: key }, props, { as: as, to: to, href: href, isLink: isLink, contentComponent: contentComponent, style: (_b = overrides === null || overrides === void 0 ? void 0 : overrides.style) !== null && _b !== void 0 ? _b : style, className: (_c = overrides === null || overrides === void 0 ? void 0 : overrides.className) !== null && _c !== void 0 ? _c : className, liStyle: (_d = overrides === null || overrides === void 0 ? void 0 : overrides.liStyle) !== null && _d !== void 0 ? _d : liStyle, liClassName: (_e = overrides === null || overrides === void 0 ? void 0 : overrides.liClassName) !== null && _e !== void 0 ? _e : liClassName, textChildren: false }),
	        leftAddon,
	...
	var Link = React.forwardRef(function Link(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Component, __assign$G({}, props, { className: className, ref: ref, rel: rel, href: href }), children));
	});
	...
	var SkipToMainContent = React.forwardRef(function SkipToMainContent(_a, ref) {
	    var _b = _a.id, id = _b === void 0 ? "skip-to-main-content" : _b, _c = _a.children, children = _c === void 0 ? "Skip to main content" : _c, _d = _a.unstyled, unstyled = _d === void 0 ? false : _d, mainId = _a.mainId, className = _a.className, onClick = _a.onClick, props = __rest$z(_a, ["id", "children", "unstyled", "mainId", "className", "onClick"]);
	    var handleClick = React.useCallback(function (event) {
	        if (onClick) {
	            onClick(event);
	        }
	    ...
	    return (React__default['default'].createElement(Link, __assign$F({}, props, { id: id, ref: ref, href: "#" + mainId, onClick: handleClick, className: classnames(block$f({ styled: !unstyled }), className) }), children));
	});
	...
	function LayoutProvider(_a) {
	    ...
	    var _g = React.useState((isPersistent && isDesktop) ||
	        isToggleableVisible(defaultToggleableVisible, layout)), visible = _g[0], setVisible = _g[1];
	...
	var styles$4 = bem("rmd-layout-title");
	/**
	...
	var LayoutAppBarTitle = React.forwardRef(function LayoutAppBarTitle(_a, ref) {
	    var propId = _a.id, className = _a.className, children = _a.children, props = __rest$y(_a, ["id", "className", "children"]);
	    var _b = useLayoutConfig(), baseId = _b.baseId, layout = _b.layout;
	    var id = propId !== null && propId !== void 0 ? propId : baseId + "-title";
	    return (React__default['default'].createElement(AppBarTitle, __assign$E({}, props, { id: id, ref: ref, className: classnames(styles$4({ offset: isFullHeightLayout(layout) }), className) }), children));
	});
	...
	var Sheet = React.forwardRef(function Sheet(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Dialog, __assign$D({}, props, { ref: ref, type: "custom", role: role, visible: visible, className: classnames(block$e((_b = {
	...
	var LayoutNavToggle = React.forwardRef(function LayoutNavToggle(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(AppBarNav, __assign$C({ id: baseId + "-nav-toggle" }, props, { "aria-label": ariaLabel, "aria-pressed": ariaPressed, ref: ref, onClick: function (event) {
	            if (onClick) {
	                onClick(event);
	            }
	            if (!visible) {
	        ...
	        }, buttonType: buttonType, tabIndex: tabIndex, className: classnames("rmd-layout-nav-toggle", className) }), children));
	});
	...
	var LayoutAppBar = React.forwardRef(function LayoutAppBar(_a, ref) {
	    var children = _a.children, _b = _a.fixed, fixed = _b === void 0 ? true : _b, propNavToggle = _a.navToggle, navToggleProps = _a.navToggleProps, customTitle = _a.customTitle, titleChildren = _a.title, titleProps = _a.titleProps, props = __rest$v(_a, ["children", "fixed", "navToggle", "navToggleProps", "customTitle", "title", "titleProps"]);
	    ...
	    if (typeof nav === "undefined") {
	        ...
	        nav = React__default['default'].createElement(LayoutNavToggle, __assign$B({ key: layout }, navToggleProps));
	    }
	    var title = customTitle;
	    if (typeof title === "undefined") {
	        title = (React__default['default'].createElement(LayoutAppBarTitle, __assign$B({}, titleProps), titleChildren));
	    }
	    return (React__default['default'].createElement(AppBar, __assign$B({ id: baseId + "-header" }, props, { ref: ref, fixed: fixed }),
	        nav,
	        title,
	        children));
	});
	...
	var styles$3 = bem("rmd-layout-main");
	/**
	...
	var LayoutMain = React.forwardRef(function LayoutMain(_a, forwardedRef) {
	    ...
	    var _g = useLayoutConfig(), layout = _g.layout, visible = _g.visible;
	    ...
	    }), _j = _h[1], ref = _j.ref, className = _j.className;
	    return (React__default['default'].createElement(Component, __assign$A({}, props, { ref: ref, tabIndex: tabIndex, className: classnames(styles$3({
	...
	var LayoutCloseNavigationButton = React.forwardRef(function LayoutCloseNavigationButton(_a, ref) {
	    var propId = _a.id, ariaLabelledBy = _a["aria-labelledby"], _b = _a["aria-label"], ariaLabel = _b === void 0 ? ariaLabelledBy ? undefined : "Hide Navigation" : _b, onClick = _a.onClick, _c = _a.first, first = _c === void 0 ? true : _c, _d = _a.last, last = _d === void 0 ? true : _d, _e = _a.buttonType, buttonType = _e === void 0 ? "icon" : _e, propChildren = _a.children, rendered = _a.rendered, props = __rest$t(_a, ["id", "aria-labelledby", "aria-label", "onClick", "first", "last", "buttonType", "children", "rendered"]);
	    ...
	    return (React__default['default'].createElement(AppBarAction, __assign$z({}, props, { id: id, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, ref: ref, first: first, last: last, buttonType: buttonType, onClick: handleClick }), children));
	});
	...
	var styles$2 = bem("rmd-layout-nav-header");
	/**
	...
	var LayoutNavigationHeader = React.forwardRef(function LayoutNavigationHeader(_a, ref) {
	    ...
	    var title = null;
	    if (propTitle) {
	        title = React__default['default'].createElement(AppBarTitle, __assign$y({}, titleProps), propTitle);
	    }
	    var action = closeNav;
	    if (typeof action === "undefined") {
	        action = React__default['default'].createElement(LayoutCloseNavigationButton, __assign$y({}, closeNavProps));
	    }
	    return (React__default['default'].createElement(AppBar, __assign$y({}, props, { ref: ref, theme: theme, className: classnames(styles$2({ bordered: !disableBorderBottom }), className) }),
	        title,
	        children,
	        action));
	});
	...
	var styles$1 = bem("rmd-layout-nav");
	/**
	...
	var LayoutTree = React.forwardRef(function LayoutTree(_a, ref) {
	    var propId = _a.id, ariaLabelledBy = _a["aria-labelledby"], _b = _a["aria-label"], ariaLabel = _b === void 0 ? ariaLabelledBy ? undefined : "Navigation" : _b, className = _a.className, _c = _a.mini, mini = _c === void 0 ? false : _c, navStyle = _a.navStyle, navClassName = _a.navClassName, navItems = _a.navItems, _d = _a.labelKey, labelKey = _d === void 0 ? "children" : _d, _e = _a.valueKey, valueKey = _e === void 0 ? "children" : _e, _f = _a.itemRenderer, itemRenderer = _f === void 0 ? mini
	        ? defaultMiniNavigationItemRenderer
	        : defaultNavigationItemRenderer : _f, selectedIds = _a.selectedIds, _g = _a.disableTemporaryAutoclose, disableTemporaryAutoclose = _g === void 0 ? false : _g, props = __rest$r(_a, ["id", "aria-labelledby", "aria-label", "className", "mini", "navStyle", "navClassName", "navItems", "labelKey", "valueKey", "itemRenderer", "selectedIds", "disableTemporaryAutoclose"]);
	    var _h = useLayoutConfig(), baseId = _h.baseId, layout = _h.layout, hideNav = _h.hideNav, visible = _h.visible;
	    ...
	    return (React__default['default'].createElement("nav", { id: id + "-nav", style: navStyle, className: classnames(styles$1({ mini: mini }), navClassName) },
	        React__default['default'].createElement(Tree, __assign$x({}, props, { id: id, ref: ref, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, data: navItems, labelKey: labelKey, valueKey: valueKey, selectedIds: selectedIds, itemRenderer: itemRenderer, className: classnames("rmd-layout-tree", className) }))));
	});
	...
	var LayoutNavigation = React.forwardRef(function LayoutNavigation(_a, ref) {
	    ...
	    if (!mini && typeof header === "undefined") {
	        header = (React__default['default'].createElement(LayoutNavigationHeader, __assign$w({ closeNav: closeNav, closeNavProps: closeNavProps, title: headerTitle, titleProps: headerTitleProps }, headerProps)));
	    }
	    return (React__default['default'].createElement(Sheet, __assign$w({}, props, { key: layout, id: id, ref: ref, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, role: !isPersistent ? "dialog" : "none", visible: visible, onRequestClose: hideNav, 
	        // do not want to portal for the other types so that logical tab order
	        // is preserved
	        portal: isTemporary, overlay: isTemporary, disableScrollLock: !isTemporary, disableTabFocusWrap: isToggleable, disableNestedDialogFixes: mini, className: classnames(styles({
	            mini: mini,
	            floating: floating,
	            "header-offset": layout === "clipped" || floating,
	        }), className) }),
	        header,
	        treeProps && React__default['default'].createElement(LayoutTree, __assign$w({}, treeProps, { mini: mini })),
	        children));
	});
	...
	function LayoutChildren(_a) {
	    var _b;
	    var _c = _a.id, id = _c === void 0 ? "layout" : _c, propAppBar = _a.appBar, appBarProps = _a.appBarProps, customTitle = _a.customTitle, title = _a.title, titleProps = _a.titleProps, navToggle = _a.navToggle, navToggleProps = _a.navToggleProps, _d = _a.navAfterAppBar, navAfterAppBar = _d === void 0 ? false : _d, propNav = _a.nav, propMiniNav = _a.miniNav, miniNavItems = _a.miniNavItems, navHeader = _a.navHeader, navHeaderProps = _a.navHeaderProps, navHeaderTitle = _a.navHeaderTitle, navHeaderTitleProps = _a.navHeaderTitleProps, closeNav = _a.closeNav, closeNavProps = _a.closeNavProps, treeProps = _a.treeProps, navProps = _a.navProps, skipProps = _a.skipProps, mainProps = _a.mainProps, children = _a.children;
	    ...
	    var _e = useLayoutConfig(), layout = _e.layout, visible = _e.visible;
	    var mini = isMiniLayout(layout);
	    var _f = React.useState(visible), miniHidden = _f[0], setMiniHidden = _f[1];
	    ...
	    if (typeof appBar === "undefined") {
	        appBar = (React__default['default'].createElement(LayoutAppBar, __assign$v({}, appBarProps, { customTitle: customTitle, title: title, titleProps: titleProps, navToggle: navToggle, navToggleProps: navToggleProps })));
	    }
	    var nav = propNav;
	    if (typeof nav === "undefined") {
	        nav = (React__default['default'].createElement(LayoutNavigation, __assign$v({ header: navHeader, headerProps: navHeaderProps, headerTitle: navHeaderTitle, headerTitleProps: navHeaderTitleProps, closeNav: closeNav, closeNavProps: closeNavProps, treeProps: treeProps }, navProps, { onEntered: function (node, isAppearing) {
	                var _a;
	    ...
	    var miniNav = propMiniNav;
	    if (mini && treeProps && typeof miniNav === "undefined") {
	        var miniTreeProps = treeProps;
	        if (miniNavItems) {
	            miniTreeProps = __assign$v(__assign$v({}, miniTreeProps), { navItems: miniNavItems });
	        }
	        miniNav = (React__default['default'].createElement(LayoutNavigation, __assign$v({ header: navHeader, headerProps: navHeaderProps, headerTitle: navHeaderTitle, headerTitleProps: navHeaderTitleProps, closeNav: closeNav, closeNavProps: closeNavProps, treeProps: miniTreeProps }, navProps, { mini: true, hidden: miniHidden })));
	    }
	    return (React__default['default'].createElement(React__default['default'].Fragment, null,
	        React__default['default'].createElement(SkipToMainContent, __assign$v({}, skipProps, { mainId: mainId })),
	        navAfterAppBar && appBar,
	        nav,
	        !navAfterAppBar && appBar,
	        miniNav,
	        React__default['default'].createElement(LayoutMain, __assign$v({ headerOffset: fixedAppBar }, mainProps, { id: mainId, mini: mini }), children)));
	}
	 ...
	 */
	function Layout(_a) {
	    var _b = _a.id, id = _b === void 0 ? "layout" : _b, _c = _a.phoneLayout, phoneLayout = _c === void 0 ? DEFAULT_PHONE_LAYOUT : _c, _d = _a.tabletLayout, tabletLayout = _d === void 0 ? DEFAULT_TABLET_LAYOUT : _d, _e = _a.landscapeTabletLayout, landscapeTabletLayout = _e === void 0 ? DEFAULT_LANDSCAPE_TABLET_LAYOUT : _e, _f = _a.desktopLayout, desktopLayout = _f === void 0 ? DEFAULT_DESKTOP_LAYOUT : _f, largeDesktopLayout = _a.largeDesktopLayout, _g = _a.defaultToggleableVisible, defaultToggleableVisible = _g === void 0 ? false : _g, props = __rest$p(_a, ["id", "phoneLayout", "tabletLayout", "landscapeTabletLayout", "desktopLayout", "largeDesktopLayout", "defaultToggleableVisible"]);
	    return (React__default['default'].createElement(LayoutProvider, { baseId: id, phoneLayout: phoneLayout, tabletLayout: tabletLayout, landscapeTabletLayout: landscapeTabletLayout, desktopLayout: desktopLayout, largeDesktopLayout: largeDesktopLayout, defaultToggleableVisible: defaultToggleableVisible },
	        React__default['default'].createElement(LayoutChildren, __assign$u({ id: id }, props))));
	}
	...
	var MediaContainer = React.forwardRef(function MediaContainer(_a, ref) {
	    ...
	    return (React__default['default'].createElement("div", __assign$t({}, props, { ref: ref, className: classnames(block$d({
	            auto: auto,
	...
	var MediaOverlay = React.forwardRef(function MediaOverlay(_a, ref) {
	    ...
	    return (React__default['default'].createElement("div", __assign$s({}, props, { ref: ref, className: classnames("rmd-media-overlay rmd-media-overlay--" + position, className) }), children));
	});
	...
	var MenuButton = React.forwardRef(function MenuButton(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Button, __assign$r({}, props, { ref: ref, "aria-haspopup": ariaHasPopup, "aria-expanded": visible ? "true" : undefined, className: classnames(block$b(), (_b = {},
	...
	var Menu = React.forwardRef(function Menu(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(ScaleTransition, { portal: portal, portalInto: portalInto, portalIntoId: portalIntoId, appear: mountOnEnter, visible: visible, classNames: classNames, timeout: timeout, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, mountOnEnter: mountOnEnter, unmountOnExit: unmountOnExit },
	        React__default['default'].createElement(OrientationProvider, { orientation: orientation },
	            React__default['default'].createElement("div", __assign$p({}, props, { "aria-orientation": orientation, ref: ref, role: role, tabIndex: tabIndex, style: __assign$p(__assign$p({}, propStyle), style), className: classnames(block$a({ horizontal: horizontal }), className), onClick: onClick, onKeyDown: onKeyDown }),
	                children,
	...
	var MenuItem = React.forwardRef(function MenuItem(_a, ref) {
	    ...
	    return (React__default['default'].createElement(ListItem, __assign$o({}, props, { ref: ref, role: role, tabIndex: tabIndex, className: classnames("rmd-menu-item", className) }), children));
	});
	...
	var MenuItemLink = React.forwardRef(function MenuItemLink(_a, ref) {
	    ...
	    return (React__default['default'].createElement("li", { role: "none" },
	        React__default['default'].createElement(ListItemLink, __assign$n({}, props, { ref: ref, role: role, tabIndex: tabIndex, className: classnames("rmd-menu-item", className) }), children)));
	});
	...
	var TableContainer = React.forwardRef(function TableContainer(_a, ref) {
	    ...
	    return (React__default['default'].createElement("div", __assign$h({}, props, { ref: ref, className: classnames("rmd-table-container", className) }), children));
	});
	...
	var Table = React.forwardRef(function Table(_a, ref) {
	    ...
	    return (React__default['default'].createElement(TableConfigProvider, { value: configuration },
	        React__default['default'].createElement("table", __assign$g({}, props, { ref: ref, className: classnames(block$9({
	                dense: dense,
	                "full-width": fullWidth,
	            }), className) }), children)));
	});
	...
	var TableHeader = React.forwardRef(function TableHeader(_a, ref) {
	    ...
	    return (React__default['default'].createElement(TableConfigProvider, { value: configuration },
	        React__default['default'].createElement("thead", __assign$f({}, props, { ref: ref, className: classnames(block$8(), className) }),
	...
	var TableBody = React.forwardRef(function TableBody(_a, ref) {
	    ...
	    return (React__default['default'].createElement(TableConfigProvider, { value: configuration },
	        React__default['default'].createElement("tbody", __assign$e({}, props, { ref: ref, className: classnames("rmd-tbody", className) }), children)));
	});
	...
	var TableFooter = React.forwardRef(function TableFooter(_a, ref) {
	    ...
	    return (React__default['default'].createElement(TableConfigProvider, { value: configuration },
	        React__default['default'].createElement(TableFooterProvider, { value: true },
	            React__default['default'].createElement("tfoot", __assign$d({}, props, { ref: ref, className: classnames(block$7(), className) }),
	                React__default['default'].createElement(StickyTableProvider, { value: sticky }, children)))));
	});
	...
	var TableRow = React.forwardRef(function TableRow(_a, ref) {
	    ...
	    return (React__default['default'].createElement("tr", __assign$c({}, props, { ref: ref, className: classnames(block$6({
	...
	var TableCellContent = React.forwardRef(function TableCellContent(_a, ref) {
	    ...
	    return (React__default['default'].createElement(UnstyledButton, { id: id, ref: ref, style: style, className: classnames(block$5("child"), className) },
	...
	var TableCell = React.forwardRef(function TableCell(_a, ref) {
	    ...
	    return (React__default['default'].createElement(Component, __assign$a({}, props, { ref: ref, id: id, "aria-sort": sortOrder === "none" ? undefined : sortOrder, colSpan: colSpan, className: classnames(block$4((_b = {
	                grow: grow,
	                header: header,
	                sticky: sticky,
	...
	var Caption = React.forwardRef(function Caption(_a, ref) {
	    ...
	    return (React__default['default'].createElement("caption", __assign$9({}, props, { ref: ref, className: classnames("rmd-caption", className) }), children));
	});
	...
	var TableCheckbox = React.forwardRef(function TableCheckbox(_a, ref) {
	    ...
	    return (React__default['default'].createElement(TableCell, __assign$8({}, props, { ref: ref, id: cellId, header: false, className: classnames("rmd-table-cell--checkbox", className) }),
	...
	var TabsList = React.forwardRef(function TabsList(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement(UpdateIndicatorStylesProvider, { value: updateIndicatorStyles },
	        React__default['default'].createElement("div", __assign$5({}, props, { "aria-orientation": orientation, style: mergedStyle, role: "tablist", className: classnames(block$3((_b = {},
	                _b[align] = true,
	                _b.padded = padded,
	...
	var Tab = React.forwardRef(function Tab(_a, propRef) {
	    ...
	    return (React__default['default'].createElement("button", __assign$4({}, props, handlers, { ref: active ? refHandler : propRef, "aria-selected": active, "aria-controls": panelId, type: "button", role: "tab", disabled: disabled, className: classnames(block$2({ active: active, stacked: icon && stacked }), className), tabIndex: active ? undefined : -1 }),
	        React__default['default'].createElement(TextIconSpacing, { icon: icon, stacked: stacked, iconAfter: iconAfter },
	            React__default['default'].createElement("span", { style: contentStyle, className: classnames(block$2("content"), contentClassName) }, children)),
	        ripples));
	});
	...
	var TabPanels = React.forwardRef(function TabPanels(_a, forwardedRef) {
	    ...
	    return (React__default['default'].createElement("div", __assign$1({}, props, { ref: refHandler, className: classnames(block$1({
	...
	var TabPanel = React.forwardRef(function TabPanel(_a, ref) {
	    ...
	    return (React__default['default'].createElement(CSSTransition, { in: transitionIn && !hidden, appear: appear, enter: enter, exit: exit, onEnter: onEnter, onEntering: onEntering, onEntered: onEntered, onExit: onExit, onExiting: onExiting, onExited: onExited, timeout: timeout, classNames: classNames },
	        React__default['default'].createElement("div", __assign({}, props, { ref: ref, role: "tabpanel", hidden: hidden, className: classnames(block(), className) }), children)));
	});
