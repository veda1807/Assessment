 ...
 * instead.
 */
export declare function TooltipHoverModeConfig({ defaultDelay, delayTimeout, enabled, children, }: TooltipHoverModeConfigProps): ReactElement;
export declare namespace TooltipHoverModeConfig {
    var propTypes: {
        enabled: any;
        delayTimeout: any;
        defaultDelay: any;
