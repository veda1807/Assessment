 ...
 * @internal
 */
export declare function LayoutChildren({ id, appBar: propAppBar, appBarProps, customTitle, title, titleProps, navToggle, navToggleProps, navAfterAppBar, nav: propNav, miniNav: propMiniNav, miniNavItems, navHeader, navHeaderProps, navHeaderTitle, navHeaderTitleProps, closeNav, closeNavProps, treeProps, navProps, skipProps, mainProps, children, }: LayoutChildrenProps): ReactElement;
