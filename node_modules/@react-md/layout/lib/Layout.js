 ...
 */
function Layout(_a) {
    var _b = _a.id, id = _b === void 0 ? "layout" : _b, _c = _a.phoneLayout, phoneLayout = _c === void 0 ? constants_1.DEFAULT_PHONE_LAYOUT : _c, _d = _a.tabletLayout, tabletLayout = _d === void 0 ? constants_1.DEFAULT_TABLET_LAYOUT : _d, _e = _a.landscapeTabletLayout, landscapeTabletLayout = _e === void 0 ? constants_1.DEFAULT_LANDSCAPE_TABLET_LAYOUT : _e, _f = _a.desktopLayout, desktopLayout = _f === void 0 ? constants_1.DEFAULT_DESKTOP_LAYOUT : _f, largeDesktopLayout = _a.largeDesktopLayout, _g = _a.defaultToggleableVisible, defaultToggleableVisible = _g === void 0 ? false : _g, props = __rest(_a, ["id", "phoneLayout", "tabletLayout", "landscapeTabletLayout", "desktopLayout", "largeDesktopLayout", "defaultToggleableVisible"]);
    return (react_1.default.createElement(LayoutProvider_1.LayoutProvider, { baseId: id, phoneLayout: phoneLayout, tabletLayout: tabletLayout, landscapeTabletLayout: landscapeTabletLayout, desktopLayout: desktopLayout, largeDesktopLayout: largeDesktopLayout, defaultToggleableVisible: defaultToggleableVisible },
